...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[SaldosXPrdoN2_D]
--with encryption
AS
--VISTA
select RucE, Ejer, left(NroCta,4) as NroCtaN2,
...
from Voucher  where IB_Anulado=0 group by RucE, Ejer, left(NroCta,4) --order by RucE, NroCta
