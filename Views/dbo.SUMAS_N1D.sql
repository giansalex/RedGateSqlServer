...
CREATE VIEW [dbo].[SUMAS_N1D]
--with encryption
AS

--VISTA
select RucE, Ejer, Cd_Fte, left(NroCta,2) as NroCta,Cd_CC, Cd_SC, Cd_SS,
...
from Voucher where IB_Anulado=0 group by RucE, Ejer, Cd_Fte, left(NroCta,2),Cd_CC, Cd_SC, Cd_SS--order by RucE, NroCta
