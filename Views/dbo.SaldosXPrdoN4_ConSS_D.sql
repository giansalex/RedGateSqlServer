...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[SaldosXPrdoN4_ConSS_D]
--with encryption
AS

--VISTA
select RucE, Ejer, NroCta as NroCtaN4, Cd_CC, Cd_SC, Cd_SS,
...
from Voucher where IB_Anulado=0  group by RucE, Ejer, NroCta, Cd_CC, Cd_SC, Cd_SS --order by RucE, NroCta
