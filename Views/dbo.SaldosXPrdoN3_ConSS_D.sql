...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[SaldosXPrdoN3_ConSS_D]
--with encryption
AS
--VISTA
select RucE, Ejer, left(NroCta,6) as NroCtaN3, Cd_CC, Cd_SC, Cd_SS,
...
from Voucher  where IB_Anulado=0 group by RucE, Ejer, left(NroCta,6), Cd_CC, Cd_SC, Cd_SS --order by RucE, NroCta
