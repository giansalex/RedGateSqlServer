...
GO
------------------------------------------------------------------------------------------------------------
CREATE VIEW [dbo].[SaldosXPrdoN2_ConSS]
--with encryption
AS
--VISTA
select RucE, Ejer, left(NroCta,4) as NroCtaN2, Cd_CC, Cd_SC, Cd_SS,
...
from Voucher  where IB_Anulado=0 group by RucE, Ejer, left(NroCta,4), Cd_CC, Cd_SC, Cd_SS --order by RucE, NroCta
