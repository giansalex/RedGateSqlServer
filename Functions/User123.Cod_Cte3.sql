...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [User123].[Cod_Cte3](@RucE nvarchar(11))
 ...
 if @c=0
      begin
		if @RucE = '20515124218' --or @RucE='20520727192' --SOLO PARA CEDIVE SAC
		 set @c='CLI0001'
		else if @RucE='20520727192'--SOLO PARA T-APRUEBO
		 set @c='CTE0001'
		else set @c='CLT0001'
	...
	begin
		...
		if @RucE =  '20515124218' --or @RucE='20520727192' --SOLO PARA CEDIVE SAC
		  ...
		  set @c ='CTE'+ right('0000'+ltrim(str(@n)),4)
