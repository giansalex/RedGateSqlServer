CREATE TABLE [dbo].[SolicitudComDet2]
(
...
GO
ALTER TABLE [dbo].[SolicitudComDet2] ADD CONSTRAINT [PK_SolicitudComDet2] PRIMARY KEY CLUSTERED  ([RucE], [Cd_SCo], [Item]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[SolicitudComDet2] ADD CONSTRAINT [FK_SolicitudComDet2_Prod_UM] FOREIGN KEY ([RucE], [Cd_Prod], [ID_UMP]) REFERENCES [dbo].[Prod_UM] ([RucE], [Cd_Prod], [ID_UMP])
GO
ALTER TABLE [dbo].[SolicitudComDet2] ADD CONSTRAINT [FK_SolicitudComDet2_Servicio2] FOREIGN KEY ([RucE], [Cd_Srv]) REFERENCES [dbo].[Servicio2] ([RucE], [Cd_Srv])
GO
ALTER TABLE [dbo].[SolicitudComDet2] ADD CONSTRAINT [FK_SolicitudComDet2_SolicitudCom2] FOREIGN KEY ([RucE], [Cd_SCo]) REFERENCES [dbo].[SolicitudCom2] ([RucE], [Cd_SCo])
GO
