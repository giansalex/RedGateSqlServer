CREATE TABLE [dbo].[OrdCompra2]
(
[RucE] [nvarchar] (11) COLLATE Modern_Spanish_CI_AS NOT NULL,
[Cd_OC] [char] (10) COLLATE Modern_Spanish_CI_AS NOT NULL,
[NroOC] [varchar] (15) COLLATE Modern_Spanish_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[OrdCompra2] ADD CONSTRAINT [PK_OrdCompra2] PRIMARY KEY CLUSTERED  ([RucE], [Cd_OC]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[OrdCompra2] ADD CONSTRAINT [FK_OrdCompra2_Area] FOREIGN KEY ([RucE], [Cd_Area]) REFERENCES [dbo].[Area] ([RucE], [Cd_Area])
GO
ALTER TABLE [dbo].[OrdCompra2] ADD CONSTRAINT [FK_OrdCompra2_FormaPC] FOREIGN KEY ([Cd_FPC]) REFERENCES [dbo].[FormaPC] ([Cd_FPC])
GO
ALTER TABLE [dbo].[OrdCompra2] ADD CONSTRAINT [FK_OrdCompra2_Moneda] FOREIGN KEY ([Cd_Mda]) REFERENCES [dbo].[Moneda] ([Cd_Mda])
GO
ALTER TABLE [dbo].[OrdCompra2] ADD CONSTRAINT [FK_OrdCompra2_Proveedor2] FOREIGN KEY ([RucE], [Cd_Prv]) REFERENCES [dbo].[Proveedor2] ([RucE], [Cd_Prv])
GO
