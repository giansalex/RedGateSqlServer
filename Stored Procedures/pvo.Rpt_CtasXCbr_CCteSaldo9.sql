...
SET ANSI_NULLS ON
GO
CREATE procedure [pvo].[Rpt_CtasXCbr_CCteSaldo9]
@RucE nvarchar(11),
@Ejer nvarchar(4),
...
begin
		...
		group by c.NDoc, c.ApPat,c.ApMat,c.Nom,c.RSocial, v.NroCta, /*v.Cd_Aux,*/ v.Cd_TD,v.NroSre,v.NroDoc,v.Cd_Prv,pr.NDoc,pr.ApPat,pr.ApMat,pr.Nom,pr.RSocial,v.Cd_Clt,v.DR_CdTD, v.DR_NSre, v.DR_NDoc--,v.Cd_MdRg, convert(varchar,v.FecMov,103), /*v.FecVD,*/ datediff(day,v.FecMov,@FechaAl) --,v.Cd_MdRg
...
--select * from voucher where ruce = '11111111111' and cd_prv = 'PRV0439'
...
--exec pvo.Rpt_CtasXCbr_CCteSaldo9 '111111111111','2011','','','','01/02/2011','30/04/2011','01',1,null
