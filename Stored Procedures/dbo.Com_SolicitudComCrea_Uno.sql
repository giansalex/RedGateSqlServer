...
SET ANSI_NULLS OFF
GO
CREATE procedure [dbo].[Com_SolicitudComCrea_Uno] --Creacion de Solicitud de Compras
@RucE nvarchar(11),
...
begin
	...
	insert into SolicitudCom
		...
		Cd_CC,Cd_SC,Cd_SS,TipAut,IB_Aut,CA01,CA02,CA03,CA04,CA05)
	       Values
		    (@RucE,@Cd_SCo,@NroSC,@FecEmi,@FecEntR,@Cd_FPC,@Asunto,@Cd_Area,@Obs,
                     @Elaboradopor,@Autorizadopor,@Cd_SR,getdate(),null,@UsuCrea,null,'01',
		@Cd_CC,@Cd_SC,@Cd_SS,isnull(@TipAut,0),0,@CA01,@CA02,@CA03,@CA04,@CA05)	
	if @@rowcount <= 0
