...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_InventarioCons_Prv_explo_PagAnt]
@RucE nvarchar(11),
@Cd_Prod char(7),
@Cd_Prv varchar(7),
@FecD datetime,
...
as
	...
	--Condicion	
	set @Cond = 'a.RucE=''' + @RucE + ''' and a.Cd_Prod='''+@Cd_Prod+''' and isnull(a.Cd_Prv, '''') like '''+@Cd_Prv+''' and a.FecMov between '''+ convert(nvarchar,@FecD,103)+''' and '''+Convert(nvarchar,@FecH,103)+''' and a.FecMov <= '''+convert(nvarchar, @Ult_Fec, 103)+' '+convert(nvarchar, @Ult_Fec, 114) +''' and not (a.Cd_Inv >= '''+Convert(nvarchar, @Ult_CdInv) +''' and  a.FecMov = '''+convert(nvarchar, @Ult_Fec, 103)+' '+convert(nvarchar, @Ult_Fec, 114) +''')'
	print @Cond
...
-- Pepito : 2010-04-08 	: <Re-Creacion y  moficacion del procedimiento almacenado>

-- Epsilower 14/04/2011 11:14:10:083 : Modificacion Correcccion del los max y min, reorden y en la condicion
...
exec dbo.Inv_InventarioCons_Prv_explo_PagSig '11111111111','PD00001','%','01/01/2010','31/12/2011',null, null, '01', 50, null, null, @NroRegs output, @NroPags output, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_Prv_explo_PagSig '11111111111','PD00001','PRV0001','01/01/2010','31/12/2011',null, null, 5, @Max, @MaxFec, @NroRegs output, @NroPags output, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_Prv_explo_PagAnt '11111111111','PD00001','PRV0004','01/01/2010','31/12/2011',null, null, 5, @Min, @MinFec, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_Prv_explo_PagSig '11111111111','PD00001','PRV0001','01/01/2010','31/12/2011',null, null, 5, @Max, @MaxFec, @NroRegs output, @NroPags output, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_Prv_explo_PagSig '11111111111','PD00001','PRV0001','01/01/2010','31/12/2011',null, null, 5, @Max, @MaxFec, @NroRegs output, @NroPags output, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_Prv_explo_PagAnt '11111111111','PD00001','PRV0001','01/01/2010','31/12/2011',null, null, 5, @Min, @MinFec, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_Prv_explo_PagAnt '11111111111','PD00001','PRV0001','01/01/2010','31/12/2011',null, null, 5, @Min, @MinFec, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
