...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_GuiaRemisionDetCons] 
@RucE nvarchar(11),
@Cd_GR char(10),
...
as
	select @PesoxCant = 1
	select GRD.Item, P.Cd_Prod, P.Nombre1,UM.Nombre,PU.DescripAlt,GRD.Cant,GRD.Cant*GRD.PesoCantKg as PesoxCant,GRD.PesoCantKg,GRD.CA01,GRD.CA02,GRD.CA03,GRD.CA04,GRD.CA05,GRD.Pend+Cant as 'Maximo'  
