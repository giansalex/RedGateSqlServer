...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_CtasXPagar_CCteSaldoAmb7]
@RucE nvarchar(11),
@Ejer nvarchar(4),
...
begin
		...
		where v.RucE=@RucE and v.Ejer=@Ejer and (v.NroCta between @NroCta1 and @NroCta2) and p.IB_CtasXPag=1 
		/*and v.Cd_Aux= @Cd_Aux*//*==*//*and v.IB_Anulado<>'1'*/ /*and ==*/ and v.FecMov <= @FechaAl 
...
--select * from voucher where ruce='11111111111' and nrodoc='59246'
--exec pvo.Rpt_CtasXPagar_CCteSaldo5 '11111111111','2010','','','','','01',null
