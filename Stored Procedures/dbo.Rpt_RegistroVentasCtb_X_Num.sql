...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_RegistroVentasCtb_X_Num]
--Reporte de registro de ventas x contabilidad ordenado x Numeración
@RucE nvarchar(11),
@Eje nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
begin
	...
	Begin
		...
		Group by v.RucE,e.RSocial,v.NroDoc,v.Ejer,v.RegCtb,v.Cd_Fte,v.IB_Anulado--,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc--,v.FecMov,v.Cd_TD,v.NroSre,v.NroDoc--,a.Cd_TDI,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom,v.IB_Anulado
		Order by v.NroDoc
		...
		Group by v.RucE,e.RSocial,v.NroDoc,v.RegCtb,v.CamMda,v.IB_Anulado
		Order by v.NroDoc
	End
	Else
	Begin
...
/* Ejemplo
exec dbo.Rpt_RegistroVentasCtb_X_Num '11111111111','2010','01','04','01',null
*/
