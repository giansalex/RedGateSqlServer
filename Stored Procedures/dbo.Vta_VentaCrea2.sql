...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_VentaCrea2]
@RucE nvarchar(11),
...
begin
	...
	insert into Venta(RucE, Cd_Vta, Eje, Prdo, RegCtb, FecMov, Cd_FPC, FecCbr,Cd_TD,NroDoc,Cd_Sr,Cd_Num,FecED,FecVD,Cd_Cte,Cd_Vdr,Cd_Area,Cd_MR,Obs/*,BIM,INF,EXO,IGV,Total*/,Cd_Mda,CamMda,FecReg,FecMdf,UsuCrea,UsuModf,IB_Anulado, DR_FecED, DR_CdTD, DR_NSre, DR_NDoc)
		   values(@RucE,@Cd_Vta,@Eje, @Prdo, @RegCtb,@FecMov, @Cd_FPC, @FecCbr,@Cd_TD, @NroDoc,@Cd_Sr,@Cd_Num,@FecED,@FecVD,@Cd_Cte,@Cd_Vdr,@Cd_Area,@Cd_MR,@Obs/*,@BIM,@INF,@EXO,@IGV,@Total*/,@Cd_Mda,@CamMda,getdate(),getdate(),@UsuCrea,@UsuCrea,0, @DR_FecED, @DR_CdTD, @DR_NSre, @DR_NDoc)
