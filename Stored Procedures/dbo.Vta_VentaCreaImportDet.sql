...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_VentaCreaImportDet]
@RucE nvarchar(11),
@Cd_Vta nvarchar(10),
@Cd_Pro nvarchar(10),
@Cant numeric(13,2),
...
--DI: Lun 24/05/2010 <Se creo el procedimiento al macenado>
		   --<Se tomo como referencia el procedimiento Vta_VtaDetalleCrea3>
GO
