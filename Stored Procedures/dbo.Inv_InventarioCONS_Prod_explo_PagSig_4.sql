...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_InventarioCONS_Prod_explo_PagSig_4]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
set language 'spanish'
	...
	else if(@Colum = 'Cd_CC') set @Cond = @Cond+' and Inv.Cd_CC + '' - '' + c.Descrip like '''+@Dato+''''
	else if(@Colum = 'Cd_SC') set @Cond=@Cond +' and Inv.Cd_SC + '' - '' + s.Descrip like '''+@Dato+''''
	else if(@Colum = 'Cd_SS') set @Cond=@Cond +' and Inv.Cd_SS + '' - '' +  ss.Descrip like '''+@Dato+''''
...
-- exec Inv_InventarioCONS_Prod_explo_PagSig_4 '20546110729','01/02/2012','28/02/2012','Cd_SS','%C#1 - CONTENEDOR # 1%',500,null,null,null,null,null,null
