...
exec dbo.Rpt_CtasXPagar_CCteResumAmb '11111111111','2009',null

*/
CREATE procedure [dbo].[Rpt_CtasXPagar_CCteResumAmb] 
@RucE nvarchar(11),
@Ejer nvarchar(4),
--@Cd_Aux nvarchar(7),
--@Prdo nvarchar(2),
...
if not exists(select * from voucher where rucE=@RucE and ejer=@Ejer)
	...
	begin
		...
		where v.RucE=@RucE and 
	      	v.Ejer=@Ejer and (left(v.NroCta,2)=42 or left(v.NroCta,2)=46)
