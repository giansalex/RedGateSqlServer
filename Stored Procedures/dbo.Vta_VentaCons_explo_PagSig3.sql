...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_VentaCons_explo_PagSig3]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
set @Consulta='		select top '+convert(varchar,@TamPag)+'
				v.Cd_Vta, v.Eje, v.Prdo, v.RegCtb, Convert(nvarchar,v.FecMov,103) as FecMov,v.Cd_MIS, v.Cd_TD, td.Descrip as TipoDoc, v.NroSre,NroDoc, v.Cd_Clt,
...
/*
set language spanish
exec Vta_VentaCons_explo_PagSig3 '11111111111','01/01/2012','28/02/2012',null,null,500,null,null,null,null,null,null
