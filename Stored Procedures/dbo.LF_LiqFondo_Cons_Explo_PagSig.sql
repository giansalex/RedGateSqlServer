...
CREATE proc [dbo].[LF_LiqFondo_Cons_Explo_PagSig]
...
set @Inter = 'Liquidacion lq
		...
		left join CCostos c on c.RucE = lq.RucE and c.Cd_CC = lq.Cd_CC
...
--  exec LF_LiqFondo_Cons_Explo_PagSig '11111111111', '01/01/2013', '31/03/2013', null, null, 100, '', null, null, null, null, null
GO
