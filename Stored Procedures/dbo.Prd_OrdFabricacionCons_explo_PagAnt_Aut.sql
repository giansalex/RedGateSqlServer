...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Prd_OrdFabricacionCons_explo_PagAnt_Aut]
...
set @Consulta = 'select * from (
		...
		ofb.CA02, ofb.CA03, ofb.CA04, ofb.CA05, ofb.CA06, ofb.CA07, ofb.CA08, ofb.CA09, ofb.CA10, case ofb.IB_Aut when 1 then 1 else 0 end as IB_Aut
		from '
		+@Inter+' 
