...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Ctb_SaldosCons_x_Prdo]
@RucE nvarchar(11),
@Eje nvarchar(4),
@PrdoIni nvarchar(2),
@PrdoFin nvarchar(2),
...
begin
	Set @SQL1 = 
		   'Select 1 as ind,a.RucE,a.Ejer,a.NroCtaN1 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total
...
begin
	...
	Set @SQL1 = @SQL1 +
		   'Select 2 as ind,a.RucE,a.Ejer,a.NroCtaN2 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total
...
begin
	...
	Set @SQL1 = @SQL1 +
		   'Select 3 as ind,a.RucE,a.Ejer,a.NroCtaN3 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total
...
begin
	...
	Set @SQL1 = @SQL1 + 
		   'Select 4 as ind,a.RucE,a.Ejer,a.NroCtaN4 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total
