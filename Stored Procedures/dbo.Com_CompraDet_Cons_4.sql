...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Com_CompraDet_Cons_4]
@RucE nvarchar(11),
@Cd_Com char(10),
@msj varchar(100) output
as
select  cd.RucE,cd.Item, cd.ItemOC, cd.Cd_Com, cd.Cd_Prod, cd.Cd_Srv, cd.Descrip, cd.PU, cd.ID_UMP, pu.DescripAlt as UM , cd.Cant, cd.Valor, cd.DsctoP, cd.DsctoI,
	...
	cd.Obs, cd.CA01, cd.CA02, cd.CA03, cd.CA04, cd.CA05, cd.CA06, cd.CA07, cd.CA08, cd.CA09, cd.CA10,IMPTot,IGVTot
