...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Prd_FormulaCons_explo_PagSig2]
@RucE nvarchar(11),
@TamPag int,
@Ult_NroFor char(10),
@NroRegs int output,
...
as
	...
	set @Consulta = 
	'select top '+Convert(nvarchar,@TamPag)+ ' p.Cd_Prod, p.CodCo1_, p.Nombre1, p.Descrip, u.ID_UMP, u.DescripAlt, count(*) as CantForm from Formula as f 
