...
--		Rpt_RegistroCompras7   '20160000001', '2016','10','11','01',1,'ASC','''01'',''03''','1',null





CREATE procedure [dbo].[Rpt_RegistroCompras7]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
SET @Consulta3 ='	
	...
	Group by v.RucE,v.Ejer,v.RegCtb, v.Cd_MdRg
...
--PV, GG: 17/11/2016>: Se agrego campo Cd_MdRg en la consulta para exportacion de PLE Compra
GO
