...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_Cliente2Mdf6]
@RucE	nvarchar(11),
@Cd_Clt	char(10),
@Cd_TDI	nvarchar(2),
@NDoc	varchar(15),
...
begin transaction
	...
	update Cliente2 set Cd_TDI=@Cd_TDI, NDoc=@NDoc, RSocial=@RSocial, ApPat=@ApPat, ApMat=@ApMat,
			   ...
			   , NComercial=@NComercial,IB_AgRet=@IB_AgRet,Cd_Vdr=@Cd_Vdr,			   
				...
				snt_LstCompsElec=@snt_LstCompsElec,snt_NroTrab=@snt_NroTrab,snt_LstRprsLegs=@snt_LstRprsLegs,snt_ActComExt=@snt_ActComExt,Snt_FecInsPLE=@Snt_FecInsPLE
