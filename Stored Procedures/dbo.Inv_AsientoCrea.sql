...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Inv_AsientoCrea] --<Procedimiento que registra los asientos contables>
@RucE nvarchar(11),
@Ejer varchar(4), 
@Cd_MIS char(3),
@Item int,
...
as
set @msj = 'Asiento no pudo ser registrado, debe de actualizar el sistema'
...
begin
	...
	insert into Asiento(RucE,Cd_MIS,Item,Cta,IC_JDCtaPA,IC_CaAb,IN_TipoCta,Cd_IV,Porc,Fmla,FmlaUsu,IC_PFI,Glosa,GlosaUsu,IC_VFG,Cd_CC,Cd_SC,Cd_SS,
		IC_JDCC,IB_Aux,IB_EsDes, IB_JalaAmr)
