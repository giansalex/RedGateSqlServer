...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Ctb_PlanCtasCrea6]
@RucE nvarchar(11),
@Ejer varchar(4),
@NroCta nvarchar(10),
@NomCta varchar(50),
...
--FL: 02/02/2011 <se agrego codigo para ver lo de balance, ingreso/egreso y Gan/Per si cambios afectan a la cuenta o tambien al padre>
