...
CREATE procedure [dbo].[Inv_InventarioCONS_Prod_explo_PagSig_6]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
---
	...
	declare @Consulta nvarchar(4000)
		set @Consulta='select top '+convert(nvarchar,@TamPag)+'
				...
				Inv.Cd_Vta, Inv.Cd_OP, Inv.Cd_Com, Inv.Cd_OC, Inv.Cd_SR, Inv.Cd_OF, 
				Inv.UsuCrea, Mda.Cd_Mda, Mda.Nombre as NombreMda from
				' +@Inter+' where 
				'+@Cond + ' order by Inv.Cd_Inv '
				
				--select top 1 * from GuiaRemision
