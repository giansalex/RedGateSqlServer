...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_Venta_CampoAdd2]
...
set @CampoInsp = (select Valor from CampoV where RucE=@RucE and Cd_Vta=@Cd_Vta and Cd_Cp='01')
	...
	select 
	       --Datos Producto--
               de.Cd_Pro, pr.Nombre as NomPro,pr.CodCo,
	       --Datos Detalle Venta--
	...
	(
	/*PROVISIONAL..DESPUES COMENTAR EL HAVING YA QUE CUANDO SE REGISTRA NO JALA LOS DATOS A LA FACTURA*/
	Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA01 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA01 Having CA01<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA02 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA02 Having CA02<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA03 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA03 Having CA03<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA04 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA04 Having CA04<>'NULL' 
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA05 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA05 Having CA05<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA06 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA06 Having CA06<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA07 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA07 Having CA07<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA08 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA08 Having CA08<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA09 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA09 Having CA09<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' '+CA10 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA10 Having CA10<>'NULL'
	--Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Pro,' ' as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Pro,CA10 Having CA10<>'NULL'
	)
	Order by 2,4
end
print @msj
