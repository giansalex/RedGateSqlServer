...
SET ANSI_NULLS ON
GO
CREATE Procedure [user321].[Inv_Serial_Explo_PagSig]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
exec Inv_Serial_Explo_PagSig '11111111111','01/03/2010','31/03/2011',null,null,4,null,null,null,null,null,null
*/
