...
CREATE procedure [dbo].[Inv_InventarioCONS_Prod_explo_PagSig_7]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
set language 'spanish'
	...
	--print @Inter
-- exec Inv_InventarioCONS_Prod_explo_PagSig_6 '11111111111','01/06/2012','28/06/2012','','',500,null,null,null,null,null,null
...
---
	...
	declare @Consulta nvarchar(4000)
		set @Consulta='select top '+convert(nvarchar,@TamPag)+'
				...
				Inv.CA01, Inv.CA02, Inv.CA03, Inv.CA04, Inv.CA05, 
				gr.NroSre + ''-'' + gr.NroGR as Cd_Gr,
				op.NroOP as Cd_OP,
				sr.NroSR as Cd_SR,
				v.NroSre+''-''+v.Nrodoc as Cd_Vta,
				com.NroSre+''-''+com.Nrodoc as Cd_Com,
				orf.NroOF as Cd_OF,
				/*Inv.Cd_Vta, Inv.Cd_OP, Inv.Cd_Com,*/ oc.NroOC as Cd_OC,/* Inv.Cd_SR, Inv.Cd_OF,*/
				Inv.UsuCrea, Mda.Cd_Mda, Mda.Nombre as NombreMda, l.NroLote, Inv.Ejer from
				' +@Inter+' where 
