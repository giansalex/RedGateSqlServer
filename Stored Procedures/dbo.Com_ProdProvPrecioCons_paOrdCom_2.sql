...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_ProdProvPrecioCons_paOrdCom_2]
@RucE nvarchar(11),
@Cd_Prv char(7),
@Cd_Prod char(7),
...
declare @colcant int
set @colcant = 1
select @check as Sel,ppp.Cd_Prod, ppp.ID_PrecPrv,convert(nvarchar,Fecha,103) as Fecha, pum.ID_UMP,pum.DescripAlt as Unidad,pum.Cd_UM, Factor, mon.Nombre as Moneda,PrecioCom as Precio,IB_IncIGV,ppp.Cd_Mda,Obs, @colcant as Cant
...
-- CE : 2013-01-04 : <Se agrego una columna adicional-> cantidad>
