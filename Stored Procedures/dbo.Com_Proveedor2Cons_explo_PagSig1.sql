...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_Proveedor2Cons_explo_PagSig1]
@RucE nvarchar(11),
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
as
		...
		*/
		...
		--------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
			...
			a.Direc,a.Telf1,a.Telf2,a.Fax,a.Correo,a.Obs,a.CtaCtb,a.CA01,a.CA02,a.CA03,a.CA04,a.CA05,a.CA06,a.CA07,a.CA08,a.CA09,a.CA10,a.Estado, a.FecReg,a.UsuCrea,a.FecMdf,UsuMdf, NComercial  from '+@Tablas+'
...
--KJ : agrego columnas: , a.FecReg,a.UsuCrea,a.FecMdf,UsuMdf
----------------------PRUEBA------------------------
