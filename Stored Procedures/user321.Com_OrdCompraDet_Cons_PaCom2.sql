...
SET ANSI_NULLS ON
GO
CREATE proc [user321].[Com_OrdCompraDet_Cons_PaCom2]
@RucE nvarchar(11),
@Cd_OC char(10),
@msj varchar(100) output
as
select oc.RucE, oc.Item,IsNull(oc.Cd_Prod,oc.Cd_Srv) as CodPrdSrv,oc.Descrip, oc.PU, oc.ID_UMP, pu.DescripAlt as UM ,oc.Cant, oc.BIM as IMP, oc.IGV,
