...
SET ANSI_NULLS ON
GO
--exec Rpt_CtasXPagar_CCteSaldo11_Fec '11111111111','2011','08/06/2011','15/06/2011','02',1,null,null,null,null
CREATE procedure [dbo].[Rpt_CtasXPagar_CCteSaldo11_Fec]
@RucE nvarchar(11),
@Ejer varchar(4),
@FecIni datetime,
@FecFin datetime,
...
--Exec [pvo].[Rpt_CtasXPagar_CCteSaldo9_Fec] @RucE,@Ejer,@Cd_Prv,@NroCta1,@NroCta2,@FecIni,@FecFin,@Cd_Mda,@IB_VerSaldados,@msj output
--return
