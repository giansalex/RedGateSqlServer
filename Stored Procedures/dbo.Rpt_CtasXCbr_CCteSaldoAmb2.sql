...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_CtasXCbr_CCteSaldoAmb2]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@Cd_Aux nvarchar(7),
@NroCta1 nvarchar(10),
...
begin
	...
	where v.RucE=@RucE and v.Ejer=@Ejer and (v.NroCta between @NroCta1 and @NroCta2) and p.IB_CtasXCbr=1 /*--(left(v.NroCta,2)=12 or left(v.NroCta,2)=16)*/ and v.Cd_Aux= @Cd_Aux and (MtoD_ME+MtoH_ME)<>0 and (MtoD+MtoH)<>0  and v.FecMov <= @FechaAl
	group by /*v.RucE,*/ v.Cd_TD, v.NroSre,v.NroDoc,a.NDoc, v.NroCta, v.Cd_Aux, convert(varchar,v.FecMov,103), v.FecVD, datediff(day,v.FecMov,@FechaAl), v.Cd_MdRg,a.ApPat,a.ApMat,a.Nom,a.RSocial 
	order by v.Cd_TD,v.NroSre,v.NroDoc,NomAux
