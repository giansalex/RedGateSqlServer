...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_ConsultaMargenes_1]
@RucE nvarchar(11),
...
if(@Cd_Area is null or @Cd_Area = '')
begin
	if(@Cd_Prod is null or @Cd_Prod = '')--Buscar todos los productos
	begin
				Select 
...
print @FecIni
print @FecFin + '23:59:29'

--select top 5 * from venta where RegCtb = '11111111111'
-- LEYENDA
-- CAM 19/09/2011 Creacion
-- exec Vta_ConsultaMargenes_1 '20513272848','01/08/2011 00:00:00','31/08/2011 00:00:00','PD00004','01','',''
-- exec Vta_ConsultaMargenes_1 '11111111111','01/03/2012','31/03/2012','','01',null,''


--select * from Venta where RUcE = '11111111111' and 
GO
