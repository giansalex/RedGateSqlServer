...
SET ANSI_NULLS ON
GO
CREATE procedure [pvo].[Ctb_VoucherInsert6]
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
insert into Voucher ( RucE, Cd_Vou, Ejer, Prdo, RegCtb, Cd_Fte, FecMov, FecCbr, NroCta, Cd_Aux, Cd_TD, NroSre,
		      ...
		      Cd_SC, Cd_SS,  Cd_Area, Cd_MR, NroChke, Cd_TG, IC_CtrMd, FecReg, UsuCrea, IC_TipAfec, IB_Anulado,Cd_Prv/*,IB_Imdo*/)


		values( @RucE, @Cd_Vou, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @NroCta, @Cd_Aux, @Cd_TD, @NroSre,
			@NroDoc, @FecED, @FecVD, @Glosa, @MtoOr, @MtoD, @MtoH, @MtoD_ME, @MtoH_ME, @Cd_MdOr, @Cd_MdRg, @CamMda, @Cd_CC,
			@Cd_SC, @Cd_SS,  @Cd_Area, @Cd_MR, @NroChke, @Cd_TG, @IC_CtrMd, getdate(), @UsuCrea, @IC_TipAfec, 0,@Cd_Prv/*,@IB_Imdo*/)
