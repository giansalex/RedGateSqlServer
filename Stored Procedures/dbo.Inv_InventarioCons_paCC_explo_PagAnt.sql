...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_InventarioCons_paCC_explo_PagAnt]
@RucE nvarchar(11),
@Cd_Prod char(7),
@Cd_CC nvarchar(8),
@Cd_SC nvarchar(8),
...
as
	...
	set @Consulta = '	select *from(select top '+ convert(nvarchar,@TamPag) +'
		a.Cd_Inv, a.RegCtb, a.ID_UMP, q.DescripAlt as Descript1, a.ID_UMBse,z.DescripAlt as Descript2, a.Cd_Prod, c.CodCo1_, c.Nombre1 as NombreProducto, a.FecMov,
...
-- Epsilower 14/04/2011 10:51:00:831 : Modificacion Correcccion del los max y min, reorden y en la condicion
...
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_paCC_explo_PagAnt '11111111111','PD00001','0001',null,null,'01/01/2010','31/12/2011',null, null, 10, @Min, @MinFec, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_paCC_explo_PagSig '11111111111','PD00001','0001',null,null,'01/01/2010','31/12/2011',null, null, 10, @Max, @MaxFec, @NroRegs output, @NroPags output, @Max output, @Min output, @MaxFec output, @MinFec output, null
select @NroRegs,@NroPags, @Min, @MinFec, @Max, @MaxFec
exec dbo.Inv_InventarioCons_paCC_explo_PagSig '11111111111','PD00001','0001',null,null,'01/01/2010','31/12/2011',null, null, 10, @Max, @MaxFec, @NroRegs output, @NroPags output, @Max output, @Min output, @MaxFec output, @MinFec output, null
