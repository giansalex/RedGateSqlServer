...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Tsr_VoucherCons_explo_PagAnt1]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@PrdoIni nvarchar(2),
@PrdoFin nvarchar(2),
...
as
	...
	--Condicion	
	set @Cond = 'vou.RucE='''+@RucE+''' and vou.Ejer='''+@Ejer+''' and vou.Prdo between '''+ @PrdoIni+''' and ''' +@PrdoFin +''' and vou.Cd_Fte=''CB'' and vou.Cd_Vou > '''+ Convert(nvarchar, isnull(@Ult_CdTsr,'')) +''''
...
--MM : 10/12/10		: ModificaciÃƒÂ³n del sp (comprobacion de @Max y @Min)
