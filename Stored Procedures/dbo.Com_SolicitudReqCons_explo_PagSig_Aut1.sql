...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_SolicitudReqCons_explo_PagSig_Aut1]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
--exec Com_SolicitudReqCons_explo_PagSig_Aut '11111111111','01/01/2009','31/12/2011',null,null,'mmedrano',50,'',null,null,null,null,null
