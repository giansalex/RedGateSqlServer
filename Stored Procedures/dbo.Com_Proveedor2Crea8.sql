...
create procedure [dbo].[Com_Proveedor2Crea8]
@RucE nvarchar(11),
...
-----	
	...
	DiasCobro=@DiasCobro, LimiteCredito=@LimiteCredito, PerCobro=@PerCobro, CtasCrtes=@CtasCrtes, NComercial=@NComercial
	...
	begin
		...
		insert into Proveedor2(RucE,Cd_Prv,Cd_TDI,NDoc,RSocial,ApPat,ApMat,Nom,Cd_Pais,CodPost,Ubigeo,Direc,Telf1,Telf2,Fax,Correo,PWeb,Obs,CtaCtb,Estado,CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10,IB_SjDet,Cd_TPrv,FecReg,UsuCrea,Grupo,DiasCobro,LimiteCredito,PerCobro,CtasCrtes,NComercial)
		       values(@RucE, @Cd_Prv,@Cd_TDI,@NDoc,@RSocial,@ApPat,@ApMat,@Nom,@Cd_Pais,@CodPost,@Ubigeo,@Direc,@Telf1,@Telf2,@Fax,@Correo,@PWeb,@Obs,@CtaCtb,@Estado,@CA01,@CA02,@CA03,@CA04,@CA05,@CA06,@CA07,@CA08,@CA09,@CA10,@IB_SjDet,@Cd_TPrv,GETDATE(),@UsuCrea,@Grupo,@DiasCobro,@LimiteCredito,@PerCobro,@CtasCrtes,@NComercial)
