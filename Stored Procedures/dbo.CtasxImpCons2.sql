...
CREATE procedure [dbo].[CtasxImpCons2]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@RegCtb nvarchar(15),
@NroCta nvarchar(10),
...
select @RegCtb as RegCtb, @NroCta as NroCta,pc.NomCta,v.Ejer,
...
case when min(Cd_MdRg) ='01' then 'S/.' else 'US$' end as Moneda
from Voucher as v 
...
group by pc.NomCta,v.Ejer

--LEYENDA
--CE: se modifico SP 
--Prueba:
--exec CtasxImpCons2 '11111111111','2012','CPGE_RC08-00003','60.1.3.10',null
GO
