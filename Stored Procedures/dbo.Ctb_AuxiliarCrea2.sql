...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Ctb_AuxiliarCrea2]
@RucE nvarchar(11),
--@Cd_Aux nvarchar(7),
@Cd_TDI nvarchar(2),
@NDoc nvarchar(15),
...
declare @Cd_Aux varchar(7)
	...
	insert into Auxiliar(RuCE,Cd_Aux,Cd_TDI,NDoc,RSocial,ApPat,ApMat,Nom,Cd_Pais,CodPost,
		     ...
		     values(@RuCE,@Cd_Aux,@Cd_TDI,@NDoc,@RSocial,@ApPat,@ApMat,@Nom,@Cd_Pais,@CodPost,
			    @Ubigeo,@Direc,@Telf1,@Telf2,@Fax,@Correo,@PWeb,@Obs,@Cd_TA,1,@CA01,@CA02,@CA03,@CA04,@CA05,@CA06,@CA07,@CA08,@CA09,@CA10)
	if @@rowcount <= 0
...
print @msj
--DI 23/01/2009
--DI 04/01/2009 MODIFICACION: Insertando cuentas en cliente o proveedor respecto al tipo de auxiliar asignado
