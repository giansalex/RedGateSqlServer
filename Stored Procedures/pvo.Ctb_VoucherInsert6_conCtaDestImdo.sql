...
SET ANSI_NULLS ON
GO
CREATE procedure [pvo].[Ctb_VoucherInsert6_conCtaDestImdo]
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
--				else set @Mto=@MtoH
				...
				begin
					...
					exec pvo.Ctb_VoucherInsert4Imdo @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @CtaD, /*@Cd_Aux,*/ @Cd_Clt, @Cd_Prv, @Cd_TD, @NroSre, @NroDoc, @FecED, @FecVD, @Glosa, @MtoOr, 
				...
				begin
					...
					exec pvo.Ctb_VoucherInsert4Imdo @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @CtaH, /*@Cd_Aux,*/ @Cd_Clt, @Cd_Prv, @Cd_TD, @NroSre, @NroDoc, @FecED, @FecVD, @Glosa, @MtoOr, 
