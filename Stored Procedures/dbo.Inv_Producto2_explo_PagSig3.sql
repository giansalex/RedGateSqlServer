...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_Producto2_explo_PagSig3]
@RucE nvarchar(11),
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
			...
			set @Consulta = ' select distinct top '+Convert(nvarchar,@TamPag)+' a.RucE,a.Cd_Prod,a.Nombre1,a.Nombre2,a.Descrip,a.NCorto,a.Cta1,a.Cta2,a.Cta3,a.Cta4,a.Cta5,a.Cta6,a.Cta7,a.Cta8,a.CodCo1_,a.CodCo2_,a.CodCo3_,
			...
			convert(bit,case(c.Cd_ProdB) when a.Cd_Prod then convert(bit,1) else convert(bit,0) end) as EsGrupo from '+@Tablas+'
