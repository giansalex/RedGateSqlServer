...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_CampoValCrea2]
@RucE nvarchar(11),
@Cd_Vta nvarchar(10),
@Cd_Cp nvarchar(2),
@Valor varchar(100),
...
begin
	...
	/*--------------------------------------------------------------------------------*/
	-- Validando que el Campo Adicional Periodo sea Fecha
	/*--------------------------------------------------------------------------------*/
	else if(@RucE ='20101949461' and @Cd_Cp='02')
	begin
		if isdate(@Valor)=0
		begin
		   set @msj ='El formato de la fecha no la correcta. Ej. dd/mm/aaaa'
		   return
		end
