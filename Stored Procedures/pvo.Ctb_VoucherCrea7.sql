...
SET ANSI_NULLS ON
GO
CREATE procedure [pvo].[Ctb_VoucherCrea7] --Modificacion: 7C
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
*/
	...
	begin
		...
		exec pvo.Ctb_VoucherInsert4 @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @NroCta, @Cd_Aux, @Cd_TD, @NroSre,
