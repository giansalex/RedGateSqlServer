...
SET ANSI_NULLS ON
GO
CREATE Procedure [user321].[Rpt_OrdFabricacion2]
/*
...
/**************************DETALLE - DetalleConceptoCosto -- Otros Conceptos***************************************************/

select t1.Ruce, t1.cd_com, t1.cd_of, t2.TotalCompra_SumaBIM, t1.Costo, t1.cd_cos
from
(
...
--print @msj
--data
exec Rpt_OrdFabricacion2 '11111111111','OF00000027',@msj out 
print @msj
*/
/*****Leyenda**************/
