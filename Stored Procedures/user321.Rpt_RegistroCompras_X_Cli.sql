...
SET ANSI_NULLS ON
GO
CREATE procedure [user321].[Rpt_RegistroCompras_X_Cli]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
select 	com.RegCtb, Convert(nvarchar,com.FecMov,103) as FecED, Convert(nvarchar,com.FecVD,103) as FecVD ,
	...
	com.DR_CdTD,com.DR_NSre,com.DR_NDoc,t.NCorto+'- '+prov.NDoc as Grupo
from 	Compra com left join Proveedor2 prov on prov.RucE=com.RucE and prov.Cd_Prv=com.Cd_Prv 
	inner join TipDocIdn t on t.Cd_TDI=prov.Cd_TDI
