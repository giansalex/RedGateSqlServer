...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_Inventario_EstadoConsUn_4]
...
begin
	select * from OrdCompra where RucE = @RucE and Cd_OC = @Cd_OC and Id_EstOC in ('01','02')
	if(@@ROWCOUNT = 0)
	begin
...
--LEYENDA:
-- CAM <Fecha: 04/02/2011><Creacion del sp>
-- CAM <Fecha: 09/02/2011><Cambio de Version a (2) del sp>
-- CAM <Fecha: 11/02/2011><Cambio de Version a (3) del sp> <Se cambio la forma en que se devuelve el resultado>
-- CAM <Fecha: 27/02/2011><Cambio de Version a (4) del sp> <Se agrego la columna OF>


-- sp_help Inv_Inventario_EstadoConsUn_4
-- PARA COMPRAS
-- exec Inv_Inventario_EstadoConsUn_4 '11111111111','CM00000113',null,null,null,null,null,null,null,null,''
-- PARA VENTAS
-- exec Inv_Inventario_EstadoConsUn_4 '11111111111',null,'VT00000349',null,null,null,null,null,null,null,''
-- PARA ORDEN DE COMPRA
-- exec Inv_Inventario_EstadoConsUn_4 '11111111111',null,null,'OC00000091',null,null,null,null,null,null,''
-- PARA ORDEN DE PEDIDO
-- exec Inv_Inventario_EstadoConsUn_4 '11111111111',null,null,null,'OP00000030',null,null,null,null,null,''
-- PARA SOLICITUD DE REQUERIMIENTO
-- exec Inv_Inventario_EstadoConsUn_4 '11111111111',null,null,null,null,'SR00000029',null,null,null,null,''
-- PARA SOLICITUD DE COMPRA
-- exec Inv_Inventario_EstadoConsUn_4 '11111111111',null,null,null,null,null,null,'SC00000123',null,null,''
