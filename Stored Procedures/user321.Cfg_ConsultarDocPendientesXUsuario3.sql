...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [user321].[Cfg_ConsultarDocPendientesXUsuario3]
@RucE nvarchar(11),
@Ejer varchar(4),
@usuario varchar(10)
as
...
else '' end ) end ) end) end as 'COD', count(doc) as 'Docs' 
FROM (
select * from (
...
--exec Cfg_ConsultarDocPendientesXUsuario3 '11111111111','2011','mmedrano'
GO
