...
SET ANSI_NULLS ON
GO
create proc [dbo].[Com_Compra_ConsUn1]
@RucE nvarchar(11),
@Cd_Com char(10),
...
begin
	select 	co.Cd_Com, co.Ejer, co.Prdo, co.RegCtb, Convert(nvarchar,co.FecMov,103) as FecMov, co.Cd_FPC, Convert(nvarchar,co.FecAPag,103) as FecAPag,
		...
		case(isnull(len(p2.RSocial),0)) when 0 then p2.ApPat + ' ' + p2.ApMat + ', '+ p2.Nom else p2.RSocial end as Nomb_Prv,co.Cd_Area,co.Cd_CC,
...
-- exec Com_Compra_ConsUn1 '11111111111', 'CM00000434', null


--select * from Compra where RucE = '11111111111'
