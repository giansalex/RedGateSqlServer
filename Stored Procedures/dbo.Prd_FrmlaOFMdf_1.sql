...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Prd_FrmlaOFMdf_1]
        	@RucE nvarchar(11),
        	@Cd_OF char(10),
        	@Item int,
		@Cd_Prod char(7),
	...
	begin 
	update FrmlaOF set
	Cd_Prod=@Cd_Prod,ID_UMP=@ID_UMP,CU=@CU,CU_ME=@CU_ME,Cant=@Cant,Costo=@Costo,Costo_ME=@Costo_ME,Mer=@Mer,MerPorc=@MerPorc,Obs=@Obs,Cd_Cos=@Cd_Cos
