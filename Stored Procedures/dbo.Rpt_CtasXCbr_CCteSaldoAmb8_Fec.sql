...
GO
--
CREATE procedure [dbo].[Rpt_CtasXCbr_CCteSaldoAmb8_Fec]
@RucE nvarchar(11),
@Ejer nvarchar(4),
...
set @Consulta2 = '
	...
	Max(Case When isnull(IB_EsProv,0)=1 Then Convert(varchar,v.FecED,103) Else Convert(varchar,v.FecMov,103) End) as FecED,
...
Where v.RucE='''+@RucE+''' and v.Ejer='''+@Ejer+''' and v.FecMov between '''+convert(varchar,@FechaIni)+''' and '''+convert(varchar,@FechaFin + ' 23:59:29')+'''
...
--JA: 08/09/2011 <Modifique el reporte con la nueva estructura de cuentas por cobrar>
print @msj
GO
