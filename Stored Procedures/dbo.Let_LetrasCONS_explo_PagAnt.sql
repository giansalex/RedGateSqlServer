...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Let_LetrasCONS_explo_PagAnt]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
-- Di : 08/03/2012 <Se agrego las columnas de pElim,pAnul>
	...
	--exec Let_LetrasCONS_explo_PagAnt
 --'11111111111','01/01/2012','28/12/2012',null,null,3,null,null,null,null,null,null
