...
SET ANSI_NULLS ON
GO
create procedure [dbo].[Inv_ProdInvAgrega2]
@RucE nvarchar(11),
...
select distinct
	@check as Sel,p.Cd_Prod,p.Nombre1 as NomProd,p.Descrip, @cant as Cant,
...
-- CAM: 2011-11-18 : modificacion. agregue descrip de producto
GO
