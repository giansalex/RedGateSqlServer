...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_VentaCons_explo_PagSig]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
--
	...
	declare @Consulta nvarchar(4000)
		set @Consulta='		select top '+convert(nvarchar,@TamPag)+'
				...
				v.Cd_TD, td.Descrip as TipoDoc, v.NroSre,NroDoc, v.Cd_Clt,v.Cd_MIS,
				...
				v.Cd_Mda,mo.Nombre as Moneda, v.CamMda, v.Obs, isnull(v.Valor,''0.00'') as Valor, isnull(v.TotDsctoP,''0.00'') as TotDsctoP, isnull(v.TotDsctoI,''0.00'') as TotDsctoI, isnull(v.ValorNeto,''0.00'') as ValorNeto, isnull(v.BaseSinDsctoF,''0.00'') as BaseSinDsctoF, isnull(v.DsctoFnz_P,''0.00'') as DsctoFnz_P, isnull(v.DsctoFnz_I,''0.00'') as DsctoFnz_I,
				...
				isnull(v.INF_Neto,''0.00'') as INF_Neto, isnull(v.EXO_Neto,''0.00'') as EXO_Neto, isnull(v.EXPO_Neto,''0.00'') as EXPO_Neto, isnull(v.BIM_Neto,''0.00'') as BIM_Neto, isnull(v.IGV,''0.00'') as IGV, case(v.IGV) when 0 then 0 else 1 end as IncIGV, isnull(v.Total,''0.00'') as Total, isnull(v.Percep, ''0.00'') as Percep,
				v.Cd_FPC, fp.Nombre as FormaPago, Convert(nvarchar,v.FecCbr,103) as FecCbr, v.IB_Cbdo,
				...
				v.Cd_Area, ar.Descrip as Area, v.Cd_CC, v.Cd_SC, v.Cd_SS, v.DR_CdVta,
				Convert(nvarchar,v.DR_FecED,103) as DR_FecED, v.DR_CdTD, v.DR_NSre, v.DR_NDoc,
				v.CA01, v.CA02, v.CA03, v.CA04, v.CA05, v.CA06, v.CA07, v.CA08, v.CA09, v.CA10, v.CA11, v.CA12, v.CA13, v.CA14, v.CA15,
				v.Cd_OP, Convert(nvarchar,v.FecReg,103) as FecReg, Convert(nvarchar,v.FecMdf,103) as FecMdf, v.UsuCrea, v.UsuModf,
