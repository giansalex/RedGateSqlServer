...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_Venta_CampInf4]
@RucE nvarchar(11),
@Eje nvarchar(4),
@Cd_Vta nvarchar(10),
...
set @CampoInsp = (select Valor from CampoV where RucE=@RucE and Cd_Vta=@Cd_Vta and Cd_Cp='01')
	...
	left join Cliente2 ca on ca.RucE=ve.RucE and ca.Cd_Clt=ve.Cd_Clt
	...
	Group by ve.RucE,em.RSocial,em.Direccion,ca.Cd_Aux,ca.Cd_TDI,ti.Descrip,ca.NDoc,ca.ApPat,
		ca.ApMat,ca.Nom,ca.RSocial,ca.RSocial,ca.Direc,ca.Telf1,ca.Telf2,ve.Cd_Vta,ve.FecMov,
		ve.FecCbr,/*ve.Cd_Sr,se.NroSerie,nu.NroAutSunat,*/ve.FecED,ve.FecVD,ve.Cd_MR,ve.Obs,ve.INF_Neto,ve.EXO_Neto,ve.BIM_Neto,ve.IGV,ve.NroSre,/*ve.INF,ve.EXO,ve.BIM,ve.IGV,*/
	...
	select 
	       --Datos Producto--
               de.RucE,de.Cd_Prod, pr.Nombre1 as NomPro,pr.CodCo1_ as CodCo ,de.Cd_Vta,pr.Descrip as DescripPro,
	       --Datos Detalle Venta--
	...
	where de.RucE=@RucE and de.Cd_Vta=@Cd_Vta and 
	      ...
	      pr.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	...
	Select de.RucE,de.Cd_Vta,de.Nro_RegVdt as NroPro,de.Cd_Prod as Cd_Pro,
	case(isnull(len(de.CA01),0)) 
	when 0 
	then ' ' 
	else de.CA01 
	...
	de.RucE=pr.RucE and de.Cd_Prod=pr.Cd_Prod and
	se.RucE=gr.RucE and se.Cd_GS=gr.Cd_GS and 
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod,de.CA01
	--Having CA01 <> ' ' 
	--Union All 
	Union
	/*------------------CAMPO INFORMATIVO 02------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod,de.CA02
	--Having CA02 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 03------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA03
	--Having CA03 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 04------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA04    
	--Having CA04 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 05------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA05   
	--Having CA05 <> ' ' 
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 06------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA06
	--Having CA06 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 07------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA07
	--Having CA07 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 08------------------*/
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA08
	--Having CA08 <> ' '
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA09
	Union
	/*------------------CAMPO INFORMATIVO 10------------------*/
	Select  de.RucE,de.Cd_Vta,de.Nro_RegVdt as NroPro,de.Cd_Prod as Cd_Pro,
	case(isnull(len(de.CA10),0)) 
	...
	de.RucE=se.RucE and se.Cd_Srv=se.Cd_Srv and
	de.RucE=um.RucE and de.ID_UMP=um.ID_UMP and de.Cd_Prod=um.Cd_Prod --and CA01<>null      
	Group by de.RucE,de.Cd_Vta,de.Nro_RegVdt,de.Cd_Prod, de.CA10
	--Having CA10 <> ' '
	)
	Order by de.Nro_RegVdt,de.Cd_Pro
	------------------------------------------------------------------------------------
	select RucE,Cd_Vta,left(convert(varchar,FecMov,103),2) as dia ,case(right(left(convert(varchar,FecMov,103),5),2)) When '01' Then 'Enero'
	...
	right(convert(varchar,FecMov,103),4) as Anio from venta
