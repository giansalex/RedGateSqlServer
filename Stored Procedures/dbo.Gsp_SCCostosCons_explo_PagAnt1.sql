...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Gsp_SCCostosCons_explo_PagAnt1]
@RucE nvarchar(11),
@Cd_CC nvarchar(16),
@TamPag int,
@Ult_SC nvarchar(16),
...
as
	...
	set @Consulta = 
	'select *from (select top '+Convert(nvarchar,@TamPag)+' RucE,Cd_CC,Cd_SC,Descrip,NCorto,CA01,CA02,CA03,CA04,CA05 from 
