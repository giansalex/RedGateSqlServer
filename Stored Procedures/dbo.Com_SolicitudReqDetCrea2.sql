...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_SolicitudReqDetCrea2]
@RucE nvarchar(11),
@Cd_SR char(10),
@Item int,
@Cd_Prod char(7),
...
begin 
	...
	insert into SolicitudReqDet(RucE,Cd_SR,Item,Cd_Prod,Cd_Srv,Descrip,Id_UMP,Cant,Obs,FecMdf,UsuMdf,CA01,CA02,CA03,CA04,CA05)
	values(@RucE,@Cd_SR,@Item,@Cd_Prod,@Cd_Srv,@Descrip,@Id_UMP,@Cant,@Obs,getdate(),@UsuMdf,@CA01,@CA02,@CA03,@CA04,@CA05)
