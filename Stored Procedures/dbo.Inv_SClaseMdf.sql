...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_SClaseMdf]
@RucE nvarchar(11),
@Cd_CL char(3),
@Cd_CLS char(3),
@Nombre varchar(50),
...
begin
	update ClaseSub set Nombre=@Nombre,NCorto=@NCorto,Estado=@Estado,CA01=@CA01,CA02=@CA02
	where RucE=@RucE and Cd_CL=@Cd_CL and Cd_CLS=@Cd_CLS

	if @@rowcount <= 0
	   set @msj = 'Sub Clase no pudo ser modificada'
end
print @msj
GO
