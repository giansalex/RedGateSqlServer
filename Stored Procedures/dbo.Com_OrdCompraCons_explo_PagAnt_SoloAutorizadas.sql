...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Com_OrdCompraCons_explo_PagAnt_SoloAutorizadas]
...
as
	...
	set @Consulta = 'select * from (select top '+Convert(nvarchar,@TamPag)+' oc.Cd_OC, oc.NroOC,oc.Cd_Prv,
			...
			oc.Cd_CC,oc.Cd_SC,oc.Cd_SS, oc.UsuCrea, pr.NDoc as RucProv, oc.CA01, oc.CA02, oc.CA03, oc.CA04, oc.CA05, oc.CA06, oc.CA07, oc.CA08, oc.CA09, oc.CA10, oc.CA11, oc.CA12, oc.CA13, oc.CA14, oc.CA15 
			from '
			+@Inter+' 
