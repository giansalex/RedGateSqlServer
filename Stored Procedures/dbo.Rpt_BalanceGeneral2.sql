...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_BalanceGeneral2]
...
'	Select 
	...
	From 
	(	Select 
			v.RucE,v.Ejer,left(v.NroCta,2) As NroCta,v.Prdo As Concepto,p.Cd_Blc,Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+') As Monto
		From 
			Voucher v
		...
		Where 
			...
			'+@Condicion+'
		Group by
			v.RucE,v.Ejer,left(v.NroCta,2),v.Prdo,p.Cd_Blc
		Having
...
'	Select 
	...
	From 
	(	Select 
			v.RucE,v.Ejer,left(v.NroCta,4) As NroCta,v.Prdo As Concepto,p.Cd_Blc,Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+') As Monto
		From 
			Voucher v
			Inner Join PlanCtas p On p.RucE=v.RucE and p.Ejer=v.Ejer and p.NroCta=v.NroCta and isnull(p.Cd_Blc,'''') in (''A100'',''A200'',''P100'',''P200'',''PT10'')
		Where 
			...
			'+@Condicion+'
		Group by
			v.RucE,v.Ejer,left(v.NroCta,4),v.Prdo,p.Cd_Blc
		Having
			Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+')<>0
	) As Res
		Left Join PlanCtas p On p.RucE=Res.RucE and p.Ejer=Res.Ejer and p.NroCta=Res.NroCta
...
'	Select 
	...
	From 
	(	Select 
			v.RucE,v.Ejer,left(v.NroCta,6) As NroCta,v.Prdo As Concepto,p.Cd_Blc,Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+') As Monto
		From 
			Voucher v
			Inner Join PlanCtas p On p.RucE=v.RucE and p.Ejer=v.Ejer and p.NroCta=v.NroCta and isnull(p.Cd_Blc,'''') in (''A100'',''A200'',''P100'',''P200'',''PT10'')
		Where 
			...
			'+@Condicion+'
		Group by
			v.RucE,v.Ejer,left(v.NroCta,6),v.Prdo,p.Cd_Blc
		Having
			Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+')<>0
	) As Res
		Left Join PlanCtas p On p.RucE=Res.RucE and p.Ejer=Res.Ejer and p.NroCta=Res.NroCta
...
'	Select 
	...
	From 
	(	Select 
			v.RucE,v.Ejer,v.NroCta As NroCta,v.Prdo As Concepto,p.Cd_Blc,Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+') As Monto
		From 
			Voucher v
			Inner Join PlanCtas p On p.RucE=v.RucE and p.Ejer=v.Ejer and p.NroCta=v.NroCta and isnull(p.Cd_Blc,'''') in (''A100'',''A200'',''P100'',''P200'',''PT10'')
		Where 
			...
			'+@Condicion+'
		Group by
			v.RucE,v.Ejer,v.NroCta,v.Prdo,p.Cd_Blc
		Having
			Sum(v.MtoD'+@MDA+'-v.MtoH'+@MDA+')<>0
	) As Res
		Left Join PlanCtas p On p.RucE=Res.RucE and p.Ejer=Res.Ejer and p.NroCta=Res.NroCta
