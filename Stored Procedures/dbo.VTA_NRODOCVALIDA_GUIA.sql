...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[VTA_NRODOCVALIDA_GUIA]
@RUCE NVARCHAR(11), 
@CD_SR NVARCHAR(4),
@NROGR NVARCHAR(15),
...
IF EXISTS (SELECT NROGR FROM GUIAREMISION WHERE RUCE=@RUCE AND Cd_TD=@Cd_TD and NroSre = @NroSre AND NROGR=@NROGR)
...
--FL: LUN 12/11/2010 : ADAPTACION PARA GUIA DE REMISION
GO
