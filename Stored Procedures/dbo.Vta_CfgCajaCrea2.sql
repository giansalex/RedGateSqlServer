...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_CfgCajaCrea2]
@RucE		nvarchar (22),
@Cd_Caja	nvarchar (20),
@Itm_CC		int output,
@Cd_MIS		char (3),
...
begin
	...
	insert into CfgCaja(RucE,Cd_Caja,Itm_CC,Cd_MIS,Cd_CC,Cd_SC,Cd_SS,Cd_Alm,CtaBco)
		  values(@RucE,@Cd_Caja,@Itm_CC,@Cd_MIS,@Cd_CC,@Cd_SC,@Cd_SS,@Cd_Alm,@CtaBco)
