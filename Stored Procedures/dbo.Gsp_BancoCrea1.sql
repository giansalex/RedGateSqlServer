...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Gsp_BancoCrea1]
--@Itm_BC nvarchar(10),
@RucE nvarchar(11),
@NroCta nvarchar(10),
@NCtaB nvarchar(50),
...
begin
	insert into Banco(Itm_BC,RucE,NroCta,NCtaB,NCorto,Cd_Mda,Estado,Ejer)
	values(user123.Itm_BC(@RucE),@RucE,@NroCta,@NCtaB,@NCorto,@Cd_Mda,1,@Ejer)
