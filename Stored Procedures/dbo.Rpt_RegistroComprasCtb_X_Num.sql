...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_RegistroComprasCtb_X_Num]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
--		Order by 3		
	...
	*/
	...
	begin
		...
		where v.RucE=@RucE and v.Ejer=@Ejer and v.Prdo between @RPrdo1 and @RPrdo2 and v.Cd_Fte='RC' --and (left(v.NroCta,2) in ('42','46')) and isnull(len(rtrim(v.IC_TipAfec)),0)=0 --VALIDAR  DE ACUERDO A LAS CUENTAS ASIGNADAS A CUENTAS POR PAGAR Y AUXILIAR
		Group by v.RucE,v.Ejer,v.NroDoc,v.FecED,e.RSocial,v.RegCtb,v.Cd_Fte,v.IB_Anulado--,v.RegCtb,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc/*,v.FecED,v.Cd_TD,v.NroSre,v.NroDoc,a.Cd_TDI,a.NDoc*//*,a.RSocial,a.ApPat,a.ApMat,a.Nom*/--,v.Cd_Aux
		Order by v.NroDoc
	end
	-------------------------------------------------------------------------------------------------
	...
	*/
	where v.RucE=@RucE and v.Ejer=@Ejer and v.Prdo between @RPrdo1 and @RPrdo2 and v.Cd_Fte='RC' and (len(v.IC_TipAfec) > 0)-- or left(v.NroCta,6)='40.1.1' or v.NroCta in ('40.1.0.01'))--or v.NroCta in ('40.1.4.01'))
	Group by v.RucE,v.NroDoc,v.RegCtb--,v.CamMda--,v.Cd_MdRg
	Order by v.NroDoc
	-------------------------------------------------------------------------------------------------
	...
	Group by v.RucE,v.NroDoc,v.RegCtb
	Order by v.NroDoc
...
--		Order by 3		
	...
	*/
	...
	left join proveedor2 p on p.RucE=v.RucE and p.Cd_Prv=v.Cd_Prv
	where v.RucE=@RucE and v.Ejer=@Ejer and v.Prdo between @RPrdo1 and @RPrdo2 and v.Cd_Fte='RC' --and (left(v.NroCta,2) in ('42','46')) and isnull(len(rtrim(v.IC_TipAfec)),0)=0 --VALIDAR  DE ACUERDO A LAS CUENTAS ASIGNADAS A CUENTAS POR PAGAR Y AUXILIAR
	Group by v.RucE,v.Ejer,v.NroDoc,e.RSocial,v.RegCtb,v.Cd_Fte,v.IB_Anulado--,v.RegCtb,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc/*,v.FecED,v.Cd_TD,v.NroSre,v.NroDoc,a.Cd_TDI,a.NDoc*//*,a.RSocial,a.ApPat,a.ApMat,a.Nom*/--,v.Cd_Aux
	Order by v.NroDoc
	end
	-------------------------------------------------------------------------------------------------
	--CONSULTANDO LAS BASES IMPONIBLES
...
-- Ejemplo
-- exec Rpt_RegistroComprasCtb_X_Num '11111111111','2010','01','05','01',null
-- JJ: 2010-09-20 <Modificacion : se agregaron lineas correspondientes a Proveedor2 RA01, MG02>
GO
