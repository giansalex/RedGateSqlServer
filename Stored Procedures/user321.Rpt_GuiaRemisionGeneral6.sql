...
SET ANSI_NULLS ON
GO
CREATE procedure [user321].[Rpt_GuiaRemisionGeneral6]
@RucE nvarchar(11),
@Cd_GR varchar(4000),
@NroSre varchar(5),
...
from 
      ...
      left join TipDoc tipP on tipP.Cd_TD=pr.Cd_TDI
'
...
exec user321.Rpt_GuiaRemisionGeneral6 '11111111111','''GR00000173''',null,null
