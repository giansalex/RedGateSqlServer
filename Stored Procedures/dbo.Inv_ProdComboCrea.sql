...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_ProdComboCrea]
@RucE nvarchar(11),
@Cd_ProdB char(7),
@Cd_ProdC char(7),
@Descrip varchar(100),
...
--begin
--	set @msj ='No existe Producto B'
--	return
--end

--if not exists(select * from  Producto2 where RucE=@RucE and Cd_Prod=@Cd_ProdC )
--begin
--	set @msj ='No existe Producto C'
--	return
--end

--if not exists(select * from  Prod_UM where RucE=@RucE and Cd_Prod=@Cd_ProdC and ID_UMP=@Id_UMP)
--begin
--	set @msj ='No existe Unidad de medida del Producto C'
--	return
--end
