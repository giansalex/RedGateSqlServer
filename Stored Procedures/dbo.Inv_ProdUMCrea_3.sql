...
CREATE procedure [dbo].[Inv_ProdUMCrea_3]
@RucE nvarchar(11),
@Cd_Prod char(7),
@Cd_UM char(2),
...
begin
	...
	begin
      ...
      insert into Prod_UM(RucE,Cd_Prod,Id_UMP,Cd_UM,DescripAlt,Factor,PesoKg,Volumen,EstadoUMP,IB_UMPPrin)
                values(@RucE,@Cd_Prod,dbo.Id_UMP(@RucE,@Cd_Prod),@Cd_UM,@DescripAlt,@Factor,@PesoKg,@Volumen,@EstadoUMP,@IB_UMPPrin)
