...
CREATE procedure [dbo].[Vta_Venta2Crea3]
@RucE nvarchar(11),
...
@DR_NDoc  nvarchar(15),
@IB_TieneRet bit = 0,
@MontoRet decimal(20,7) = 0.0,
@DE_EstEnvSNT varchar(2),
@DE_EstEnvClt varchar(2),
...
begin
	...
	insert into Venta(RucE,Cd_Vta,Eje,Prdo,RegCtb,FecMov,Cd_FPC,FecCbr,Cd_TD,NroDoc,
			  ...
			  DR_CdVta,DR_FecED,DR_CdTD,DR_NSre,DR_NDoc,IB_TieneRetencion,Monto_Retencion,DE_EstEnvClt,DE_EstEnvSNT)
		   values(@RucE,@Cd_Vta,@Eje,@Prdo,@RegCtb,@FecMov,@Cd_FPC,@FecCbr,@Cd_TD,@NroDoc,
			  ...
			  @Cd_OP,@Cd_CC,@Cd_SC,@Cd_SS,@NroSre,@Cd_MIS,@NroOP,
			  --Documento Referencia
			  @DR_CdVta,@DR_FecED,@DR_CdTD,@DR_NSre,@DR_NDoc,@IB_TieneRet,@MontoRet,@DE_EstEnvClt,@DE_EstEnvSNT)
	if @@rowcount <= 0
	begin
