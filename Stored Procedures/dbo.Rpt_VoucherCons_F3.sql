...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_VoucherCons_F3] --procedimiento final de la consulta de vouchers para imprimir en reporte
@RucE nvarchar(11),
@Ejer nvarchar(4),
@RegCtb1 nvarchar(15),
@RegCtb2 nvarchar(15),
...
select 
	v.RucE,e.RSocial,v.RegCtb,'S/.' as Mda1, 'US$.' as Mda2,v.UsuCrea as Usuario,v.IB_Anulado as Anulado
...
select
	...
	IsNull(IB_EsDes,0) as IB_EsDes -- agregado por JS
from Voucher v
...
where 
	v.RucE=@RucE and v.Ejer=@Ejer and v.RegCtb between @RegCtb1 and @RegCtb2
