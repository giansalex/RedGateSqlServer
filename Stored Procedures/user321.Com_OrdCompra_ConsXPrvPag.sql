...
SET ANSI_NULLS ON
GO
CREATE proc [user321].[Com_OrdCompra_ConsXPrvPag]
@RucE nvarchar(11),
@Cd_Prv char(7),
@TamPag int,
@EstaAut bit,
...
print @msj
-- Leyenda --
-- FL : 19/11/10 : <creacion del procedimiento almacenado>
-- FL : 19/11/10 : <modificacion>
-- OBSERVACIONES:
...
--Pruebas:
--exec Com_OrdCompra_ConsXPrv '11111111111','PRV0004',''
