...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_SolicitudReqCons_explo_PagSig]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
--print 'Cadena = '+@Cond
	...
	Set @CONSULTA='	select top '+Convert(nvarchar,@TamPag)+' sc.Cd_SR,sc.NroSR,
			...
			sc.FecMdf,sc.UsuCrea,sc.UsuMdf,sc.Id_EstSR,sc.Cd_CC,sc.Cd_SC,sc.Cd_SS			
			from '+@Inter+'
...
exec dbo.Com_SolicitudReqCons_explo_PagSig '11111111111','10/01/2010','20/08/2010','Cd_SR','',20,'',@NroRegs out,@NroPags out,@Max out,@Min out,null
print @NroRegs
print @NroPags
print @Max
print @Min
