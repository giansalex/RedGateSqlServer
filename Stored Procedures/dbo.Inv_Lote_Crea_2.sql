...
create procedure [dbo].[Inv_Lote_Crea_2]
@RucE nvarchar(11),
...
begin
	...
	insert into Lote (RucE,Cd_Prov,Cd_Lote,NroLote,Descripcion,FecCaducidad,UsuCrea,FecReg,FecFabricacion)
		values (@RucE,@Cd_Prov,@Cd_Lote,@NroLote,@Descripcion,@FecCaducidad,@UsuCrea,GETDATE(),@FecFabricacion)
end
else
begin
