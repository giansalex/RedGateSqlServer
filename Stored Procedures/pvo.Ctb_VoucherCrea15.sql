...
SET ANSI_NULLS ON
GO
CREATE procedure [pvo].[Ctb_VoucherCrea15] --Modificacion: 15
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
@NroCta	nvarchar(15),	
@CtaAsoc nvarchar(15),  --> cta definida en Clientes/Proveedores (60,70)
--@Cd_Aux	nvarchar(7),
----------------------
@Cd_Clt	char(10),
@Cd_Prv	char(7),
...
--Quitamos los espacios en blanco por si acaso --PV:Mdf 03/01/2017
set @NroCta = rtrim(@NroCta)
set @CtaAsoc = rtrim(@CtaAsoc)
...
--PV: Sab 09/03/2013 - Mdf: se agregó @Cd_Vou como output - a peticion de Marco Prado, para registro de CA's detalle
--PV: Mar 03/01/2017 - Mdf: Se aumento tamaño de @NroCta y @CtaAsoc a 15
