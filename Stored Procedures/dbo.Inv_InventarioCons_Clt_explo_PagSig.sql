...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_InventarioCons_Clt_explo_PagSig]
@RucE nvarchar(11),
@Cd_Prod char(7),
@Cd_Clt varchar(10),
@FecD datetime,
...
as
	...
	--Condicion	
	set @Cond = 'a.RucE=''' + @RucE + ''' and a.Cd_Prod='''+@Cd_Prod+''' and isnull(a.Cd_Clt,'''') like '''+@Cd_Clt+''' and a.FecMov between '''+ convert(nvarchar,@FecD,103)+''' and '''+Convert(nvarchar,@FecH,103)+' 23:59:59'''
...
-- Epsilower 14/04/2011 12:04:32:974 : Modificacion Correcccion del los max y min, reorden y en la condicion
