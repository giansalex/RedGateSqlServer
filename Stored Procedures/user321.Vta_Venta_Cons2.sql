...
SET ANSI_NULLS ON
GO
CREATE proc [user321].[Vta_Venta_Cons2]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@msj varchar(100) output
as

select top 200 convert(Nvarchar,  ve.FecMov,103) as FecMov,ve.RegCtb, ve.Cd_TD,ve.NroSre,ve.NroDoc,case(ve.Cd_Mda) when '01' then ve.Total else convert(numeric(13,2),ve.Total*ve.CamMda) end  as Soles ,
