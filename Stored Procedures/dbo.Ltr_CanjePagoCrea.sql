...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Ltr_CanjePagoCrea]
...
If exists (Select * From CanjePago Where RucE=@RucE and Cd_Cnj=@Cd_Cnj)
	set @msj = 'Ya existe un canje con el mismo codigo'
Else
Begin

	Set @Cd_Cnj = ( Select dbo.Cd_CnjPago(@RucE) )

	Insert into CanjePago(RucE,Ejer,Cd_Cnj,RegCtb,Prdo,FecMov,Cd_Prv,Cd_MIS,Cd_Mda,TipCam,
					  CantLtr,OtrosImp,Total,Obs,Cd_Area,Cd_CC,Cd_SC,Cd_SS,FecReg,UsuReg
					  ,CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10)
			   Values(@RucE,@Ejer,@Cd_Cnj,@RegCtb,@Prdo,@FecMov,@Cd_Prv,@Cd_MIS,@Cd_Mda,@TipCam,
