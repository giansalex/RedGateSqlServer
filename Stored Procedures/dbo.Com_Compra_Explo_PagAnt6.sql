...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_Compra_Explo_PagAnt6]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
set language Spanish
	...
	set @Consulta=	'
		       ...
		       co.BIM_S, co.IGV_S, co.BIM_E, co.IGV_E,co.BIM_C, co.IGV_C,co.Imp_N,co.Imp_O, co.Total, co.CamMda
			   ...
			   , dbo.PendComImp(co.RucE, co.Cd_Com) as PendComImp
		       , case (dbo.PendComImp(co.RucE, co.Cd_Com)) when 0 then ''Total'' when 1 then ''Parcial'' else ''Pendiente'' end  as PendComImpNom
		       from '
			+@Inter+' 
