...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_CliProConsUn] -- Consulta todos los clientes o proveedores que esten asociados a una Guia de Remision
@RucE nvarchar(11),
...
--Ventas
--exec Inv_CliProConsUn '11111111111','GR00000036',null

--Compras
--exec Inv_CliProConsUn '11111111111','GR00000015',null



--Leyenda--
--FL: 08/09/2010 : <Creacion del procedimiento almacenado>
--FL: 08/11/2010 : <Se modifico formulario para caso de varios>
--FL,PV 10/12/2010: se modifico para que jale clt, prv de donde este, y consulta segun IC_ES
