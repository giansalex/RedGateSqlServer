...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_SolicitudComMdf] --Creacion de Solicitud de Compras
@RucE nvarchar(11),
@Cd_SCo char(10),
@NroSC varchar(15),
@FecEmi datetime,
...
print @msj
--J : 04-05-2010 - <Creacion del Procedimiento Almacenado>
--MP: 21-10-2010 - <Modificaicon del Procedimiento Almacenado>
