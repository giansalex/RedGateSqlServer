...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_VentaCons_explo_PagSig2]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
-- MM : 27-05-11 	: <Creacion del procedimiento almacenado>
-- MM : 27-05-11 	: <Se agrego el cambio de valores para venta anulada>
/*
set language spanish
exec Vta_VentaCons_explo_PagSig2 '11111111111','01/01/2012','14/01/2012',null,null,500,null,null,null,null,null,null
