...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_RegistroVentasCtb_X_Cli]
--Reporte de registro de ventas x contabilidad ordenado x cliente
@RucE nvarchar(11),
@Eje nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
begin
	...
	Begin
		...
		Group by v.RucE,e.RSocial,a.RSocial,/*a.NDoc,*/v.Ejer,v.RegCtb,v.Cd_Fte,v.IB_Anulado,tdi.NCorto--,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc--,v.FecMov,v.Cd_TD,v.NroSre,v.NroDoc--,a.Cd_TDI,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom,v.IB_Anulado
		Order by a.NDoc
		...
		Group by v.RucE,e.RSocial,a.NDoc,v.RegCtb,v.CamMda,v.IB_Anulado
		Order by a.NDoc
	End
	Else
	Begin
		...
		left join Cliente2 a on v.RucE=a.RucE and v.Cd_Clt=a.Cd_Clt
		where v.RucE=@RucE and v.Ejer=@Eje and v.Prdo between @Rprdo1 and @Rprdo2 and v.Cd_Fte='RV' --and left(v.NroCta,2) in ('12','14','16')
		Group by v.RucE,e.RSocial,a.RSocial/*a.NDoc*/,v.Ejer,v.RegCtb,v.Cd_Fte,v.IB_Anulado--,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc--,v.FecMov,v.Cd_TD,v.NroSre,v.NroDoc--,a.Cd_TDI,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom,v.IB_Anulado
		Order by a.NDoc
...
-- J : 18-07-2010 -> Creado : Ordenado x Cliente
/* Ejemplo
exec dbo.Rpt_RegistroVentasCtb_X_Cli '11111111111','2010','01','04','01',null
*/

--MP: LUN 20-09-2010 Modf: Se quito las relaciones con la tabla Auxiliar y se enlazo con Cliente2
--CM: RA01
GO
