...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_Venta_Koala]
@RucE nvarchar(11),
@Eje nvarchar(4),
@Cd_Vta nvarchar(10),
...
begin
	...
	(
	Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA01 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA01 Having CA01<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA02 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA02 Having CA02<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA03 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA03 Having CA03<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA04 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA04 Having CA04<>'NULL' 
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA05 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA05 Having CA05<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA06 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA06 Having CA06<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA07 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA07 Having CA07<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA08 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA08 Having CA08<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA09 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA09 Having CA09<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' '+CA10 as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA10 Having CA10<>'NULL'
	Union All Select  Cd_Vta,Nro_RegVdt as NroPro,Cd_Prod as Cd_Pro,' ' as Campo From VentaDet Where RucE=@RucE and Cd_Vta=@Cd_Vta Group by Cd_Vta,Nro_RegVdt,Cd_Prod,CA10 Having CA10<>'NULL'
	)
	Order by 2,4
...
-- J 12/09/2010 Creacion : Reporte Factura Koala
--exec Rpt_Venta_CampoAdd '20502036549','2010','VT00000692',null
