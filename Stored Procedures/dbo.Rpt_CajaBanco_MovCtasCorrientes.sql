...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_CajaBanco_MovCtasCorrientes]
...
--exec Rpt_CajaBanco_MovCtasCorrientes '11111111111','2012','02','02','01','','',null
...
SET @SQL3= '
		...
		(
			...
			inner join PlanCtas p on p.RucE = v.RucE and p.Ejer=v.Ejer and p.NroCta = v.NroCta and p.IB_MCC = 1 
...
set @SQL4=
	...
	'
PRINT @SQL1
PRINT (@SQL3) print(@SQL2) print (@SQL4)
