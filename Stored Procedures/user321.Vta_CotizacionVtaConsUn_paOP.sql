...
SET ANSI_NULLS ON
GO
CREATE proc [user321].[Vta_CotizacionVtaConsUn_paOP]
@RucE nvarchar(11),
@Cd_Cot char(10),
...
begin
	select	co.Cd_Cot, co.NroCot, co.FecEmi, co.Cd_FPC, co.Cd_Clt,cl.Cd_TDI as Cd_TDI_Clt,cl.NDoc as NDoc_Clt,case(isnull(len(cl.RSocial),0))when 0 then cl.ApPat+' '+cl.ApMat+' '+cl.Nom else cl.RSocial end as Nomb_Clt,
	co.Cd_Vdr,ve.Cd_TDI as Cd_TDI_Vdr,ve.NDoc as NDoc_Vdr,ve.ApPat + ' ' + ve.ApMat + ',' + ve.Nom as Nomb_Vdr,co.Cd_Area, co.Cd_Mda, co.CamMda, co.Obs,
		...
		,co.CA01,co.CA02,co.CA03,co.CA04,co.CA05, co.Cd_CC, co.Cd_SC, co.Cd_SS
...
--exec Vta_CotizacionVtaConsUn_paOP '11111111111', 'CT00000206', null
