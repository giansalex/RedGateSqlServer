...
--declare 
CREATE Procedure [dbo].[Rpt_ConsCotizacion]
@RucE nvarchar(11),
@Cd_Vdr nvarchar(7),
@Ib_Pendiente bit,
@FecIni datetime,
...
,c.Cd_Mda
,c.CamMda
,case when @Cd_Mda = c.Cd_Mda then isnull(c.CostoTot,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.CostoTot,0.00) else isnull(c.CostoTot,0.00)/isnull(c.CamMda,0.00)end end as CostTot
,case when @Cd_Mda = c.Cd_Mda then isnull(c.Valor,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.Valor,0.00) else isnull(c.Valor,0.00)/isnull(c.CamMda,0.00)end end as Valor
,case when @Cd_Mda = c.Cd_Mda then isnull(c.TotDsctoI,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.TotDsctoI,0.00) else isnull(c.TotDsctoI,0.00)/isnull(c.CamMda,0.00)end end as TotDsctoI
,case when @Cd_Mda = c.Cd_Mda then isnull(c.INF,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.INF,0.00) else isnull(c.INF,0.00)/isnull(c.CamMda,0.00)end end as INF
,case when @Cd_Mda = c.Cd_Mda then isnull(c.DsctoFnzInf_I,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.DsctoFnzInf_I,0.00) else isnull(c.DsctoFnzInf_I,0.00)/isnull(c.CamMda,0.00)end end as DsctoFnzInf_I
,case when @Cd_Mda = c.Cd_Mda then isnull(c.INF_Neto,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.INF_Neto,0.00) else isnull(c.INF_Neto,0.00)/isnull(c.CamMda,0.00)end end as INF_Neto
,case when @Cd_Mda = c.Cd_Mda then isnull(c.BIM,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.BIM,0.00) else isnull(c.BIM,0.00)/isnull(c.CamMda,0.00)end end as BIM
,case when @Cd_Mda = c.Cd_Mda then isnull(c.DsctoFnzAf_I,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.DsctoFnzAf_I,0.00) else isnull(c.DsctoFnzAf_I,0.00)/isnull(c.CamMda,0.00)end end as DsctoFnzAf_I
,case when @Cd_Mda = c.Cd_Mda then isnull(c.BIM_Neto,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.BIM_Neto,0.00) else isnull(c.BIM_Neto,0.00)/isnull(c.CamMda,0.00)end end as BIM_Neto
,case when @Cd_Mda = c.Cd_Mda then isnull(c.IGV,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.IGV,0.00) else isnull(c.IGV,0.00)/isnull(c.CamMda,0.00)end end as IGV
,case when @Cd_Mda = c.Cd_Mda then isnull(c.Total,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.Total,0.00) else isnull(c.Total,0.00)/isnull(c.CamMda,0.00)end end as Total
,case when @Cd_Mda = c.Cd_Mda then isnull(c.MU_Imp,0.00) else case when @Cd_Mda = '01' then isnull(c.CamMda,0.00)*isnull(c.MU_Imp,0.00) else isnull(c.MU_Imp,0.00)/isnull(c.CamMda,0.00)end end as MU_Imp --Margen Utilidad
