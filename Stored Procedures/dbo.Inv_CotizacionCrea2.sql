...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Inv_CotizacionCrea2]
/*
...
begin
	...
	insert into Cotizacion(RucE,Cd_Cot,NroCot,FecEmi,FecCad,Cd_FPC,Asunto,Cd_Cte,Cd_Clt,Cd_Vdr,
			       ...
			       Id_EstC,Cd_FCt,TipAut,IB_Aut,CA01,CA02,CA03,CA04,CA05,Cd_CC,Cd_SC,Cd_SS)
			Values(@RucE,user123.Cod_Cot(@RucE),@NroCot,@FecEmi,@FecCad,@Cd_FPC,@Asunto,@Cd_Cte,@Cd_Clt,@Cd_Vdr,
			       ...
			       '01',@Cd_FCt,isnull(@TipAut,0),0,@CA01,@CA02,@CA03,@CA04,@CA05,@Cd_CC,@Cd_SC,@Cd_SS)
	if @@rowcount <= 0
		Set @msj = 'Error al registrar cotizacion'
end

-- Leyeda --
-- MM : 06/06/2011 : <Creacion del procedimiento almacenado>
GO
