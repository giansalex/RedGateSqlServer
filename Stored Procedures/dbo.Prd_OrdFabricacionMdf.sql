...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Prd_OrdFabricacionMdf]
        	@RucE nvarchar(11),
        	@Cd_OF char(10),
        	@NroOF varchar(50),
        	@FecE smalldatetime,
	...
	Lote=@Lote,CosTot=@CosTot,Cant=@Cant,CU=@CU,Cd_Mda=@Cd_Mda,FecMdf=@FecMdf,UsuModf=@UsuModf,Cd_CC=@Cd_CC,Cd_SC=@Cd_SC,
	Cd_SS=@Cd_SS,Id_EstOF=@Id_EstOF,TipAut=@TipAut,IB_Aut=@IB_Aut,AutorizadoPor=@AutorizadoPor,CA01=@CA01,CA02=@CA02,CA03=@CA03,
