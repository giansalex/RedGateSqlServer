...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_CompraDetCrea2]
@RucE nvarchar(11),
@Cd_Com char(10),
@Item int,
@Cd_Prod char(7),
...
begin
	...
	insert into CompraDet(RucE,Cd_Com,Item,Cd_Prod,Cd_Srv,Descrip,ID_UMP,PU,Cant,IMP,IGV,Total,Cd_IA,
				 Cd_CC,Cd_SC,Cd_SS,Cd_Alm,Obs,FecMdf,UsuModf,CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10,ItemOC)
			values(@RucE,@Cd_Com,@Item,@Cd_Prod,@Cd_Srv,@Descrip,@ID_UMP,@PU,@Cant,@IMP,@IGV,@Total,
			       @Cd_IA,@Cd_CC,@Cd_SC,@Cd_SS,@Cd_Alm,@Obs,GETDATE(),@UsuMdf,@CA01,@CA02,@CA03,@CA04,@CA05,@CA06,@CA07,@CA08,@CA09,@CA10,@ItemOC)
	if @@rowcount <= 0
