...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_AlmaCrea1]
@RucE nvarchar(11),
--@Cd_alm varchar(20),
@Codigo varchar(15),
@Nombre varchar(50),
	...
	begin
		if exists (select * from Almacen where RucE=@RucE and Codigo=@Codigo)
			...
			begin
				...
				insert into Almacen(RucE,Cd_Alm,Codigo,Nombre,NCorto,Ubigeo,Direccion,Encargado,Telef,Capacidad,Obs,Estado,CA01,CA02,CA03,CA04,CA05,IB_EsVI)
				   values(@RucE,@Cod_Alm,@Codigo,@Nombre,@NCorto,@Ubigeo,@Direccion,@Encargado,@Telef,@Capacidad,@Obs,1,@CA01,@CA02,@CA03,@CA04,@CA05,@IB_EsVI)
				if @@rowcount <= 0
