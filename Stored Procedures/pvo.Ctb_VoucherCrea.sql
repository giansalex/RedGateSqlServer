...
CREATE procedure [pvo].[Ctb_VoucherCrea]
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
/*
if exists (select * from Voucher where RucE=@RucE and Cd_Vou=@Cd_Vou)
	set @msj = 'Ya existe un voucher con el mismo numero de registro'
else
begin
*/
	...
	exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @NroCta, @Cd_Aux, @Cd_TD, @NroSre,
...
--		select * from Tasas
		...
		begin
			...
			exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @CtaAsoc, @Cd_Aux, @Cd_TD, @NroSre,
			...
			exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @CtaIGV, @Cd_Aux, @Cd_TD, @NroSre,
...
--				else set @Mto=@MtoH
				...
				begin
					exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @CtaD, @Cd_Aux, @Cd_TD, @NroSre, @NroDoc, @FecED, @FecVD, @Glosa, @MtoOr, 
								   @MtoDest, 0.00, @Cd_MdOr, @Cd_MdRg, @CamMda, @Cd_CC, @Cd_SC, @Cd_SS,  @Cd_Area, @Cd_MR, @NroChke, @Cd_TG, @IC_CtrMd, @UsuCrea, @msj output
					if @msj <> '' return
				end
				...
				begin
					exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @CtaH, @Cd_Aux, @Cd_TD, @NroSre, @NroDoc, @FecED, @FecVD, @Glosa, @MtoOr, 
								   0.00, @MtoDest, @Cd_MdOr, @Cd_MdRg, @CamMda, @Cd_CC, @Cd_SC, @Cd_SS,  @Cd_Area, @Cd_MR, @NroChke, @Cd_TG, @IC_CtrMd, @UsuCrea, @msj output
					if @msj <> '' return
				end
...
--	       @MtoD_ME = @MtoD_ME + isnull(sum(MtoD),0), @MtoH_ME = @MtoH_ME + isnull(sum(MtoH),0)
	...
	begin
		...
		begin 
			...
			set @IC_CtrMd = '$'
			set @Cd_MdRg = '02'
			exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @Cta_DCPer, null/*@Cd_Aux*/, null/*@Cd_TD*/, null/*@NroSre*/,
			     null/*@NroDoc*/, @FecED, @FecVD, @Glosa, @MtoOr, @SaldoME, 0.00, @Cd_MdOr, '02', @CamMda, @Cd_CC,
			     @Cd_SC, @Cd_SS,  @Cd_Area, @Cd_MR, @NroChke, @Cd_TG, '$', @UsuCrea, @msj output
			set @NroCta = @Cta_DCPer
		     end
		     else
		     begin
			exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @Cta_DCGan, null/*@Cd_Aux*/, null/*@Cd_TD*/, null/*@NroSre*/,
		...
		begin
			...
			exec pvo.Ctb_VoucherInsert @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @Cta_DCPer, null/*@Cd_Aux*/, null/*@Cd_TD*/, null/*@NroSre*/,
			     ...
			     @Cd_SC, @Cd_SS,  @Cd_Area, @Cd_MR, @NroChke, @Cd_TG, 's', @UsuCrea, @msj output
			set @NroCta = @Cta_DCPer
		     end
		     else
		     begin
