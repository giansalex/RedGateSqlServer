...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Pre_CCPresupFCCrea]
...
Begin Transaction
	...
	Begin  
		Insert Into dbo.PresupFC( RucE,Cd_PspFC,Ejer,Cd_CC,Cd_SC,Cd_SS,NroCta,
				     ...
				     Values( @RucE,user321.Cod_PFC(@RucE),@Ejer,@Cd_CC,@Cd_SC,@Cd_SS,@NroCta,
					     @Ene,@Ene_ME,@Feb,@Feb_ME,@Mar,@Mar_ME,@Abr,@Abr_ME,@May,@May_ME,@Jun,@Jun_ME,
		...
		If @@Rowcount <= 0
		Begin
			Set @msj = 'Error al ingresar presupuesto flujo caja'
