...
SET ANSI_NULLS ON
GO
--pvo.Rpt_CtasXPagar_CCteSaldo9_Fec '20100977037','2011','','18.9.1.90','18.9.1.90','01/01/2011','31/05/2011','01',0,null

CREATE procedure [pvo].[Rpt_CtasXPagar_CCteSaldo10_Fec]
@RucE nvarchar(11),
@Ejer nvarchar(4),
