...
SET ANSI_NULLS ON
GO
CREATE proc [user321].[Vta_Venta_ConsXClt]
@RucE nvarchar(11),
@Cd_Clt char(10),
@Ejer nvarchar(4),
@msj varchar(100) output
as
-- ESTE SP YA NO SE USA

set @msj = 'Actualizar version ContaNet'
/* 
...
--CAM : 16/11/2010 : Actualizacion <Comentado del SP xq ya no se usa>
GO
