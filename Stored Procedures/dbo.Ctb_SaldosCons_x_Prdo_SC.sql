...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Ctb_SaldosCons_x_Prdo_SC]
@RucE nvarchar(11),
@Eje nvarchar(4),
@PrdoIni nvarchar(2),
@PrdoFin nvarchar(2),
...
Set @RangoC = ''
if(isnull(len(@Cd_CCD),0) = 0 and isnull(len(@Cd_SCD),0) = 0 and isnull(len(@Cd_CCH),0) = 0 and isnull(len(@Cd_SCH),0) = 0)
Begin
	set @RangoC = ''
End
else	Set @RangoC = ' and a.Cd_CC between '''+@Cd_CCD+''' and '''+@Cd_CCH+''''+
		      ' and a.Cd_SC between '''+@Cd_SCD+''' and '''+@Cd_SCH+''''
...
Declare @a int
Set @a = 0
if(@Nivel1=1) Set @a = @a + 1
if(@Nivel2=1) Set @a = @a + 1
if(@Nivel3=1) Set @a = @a + 1
if(@Nivel4=1) Set @a = @a + 1
if(@a = 0) 
Begin
	Set @a = 4
	Set @Nivel1 = 1
...
begin
	Set @SQL1 = 
		   'Select a.RucE,a.Ejer,a.NroCtaN1 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total, b.Cd_Blc,b.Cd_EGPN,b.Cd_EGPF
		    from SaldosXPrdoN1_conSC'+@Mda+' a
...
begin
	...
	Set @SQL1 = @SQL1 +
		   'Select a.RucE,a.Ejer,a.NroCtaN2 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total, b.Cd_Blc,b.Cd_EGPN,b.Cd_EGPF
		    from SaldosXPrdoN2_conSC'+@Mda+' a
...
begin
	...
	Set @SQL1 = @SQL1 +
		   'Select a.RucE,a.Ejer,a.NroCtaN3 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total, b.Cd_Blc,b.Cd_EGPN,b.Cd_EGPF
		    from SaldosXPrdoN3_conSC'+@Mda+' a
...
begin
	...
	Set @SQL1 = @SQL1 + 
		   'Select a.RucE,a.Ejer,a.NroCtaN4 as NroCta,b.NomCta,'+@Colum+','+@Suma+' as Total, b.Cd_Blc,b.Cd_EGPN,b.Cd_EGPF
		    from SaldosXPrdoN4_conSC'+@Mda+' a
...
Set @SQL2 = 
	   'Select a.RucE,a.Ejer,''TOTALES'' as NroCta, ''=========================>'' as NomCta, '+@ColumT+','+@SumaT+' as Total, '''' as Cd_Blc,'''' as Cd_EGPN,'''' as Cd_EGPF
	    from SaldosXPrdoN'+Convert(varchar,@a)+'_conSC'+@Mda+' a
