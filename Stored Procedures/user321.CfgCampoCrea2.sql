...
SET ANSI_NULLS ON
GO
create procedure [user321].[CfgCampoCrea2]
@RucE nvarchar(11),
@Id_CTb int,
@Id_TDt int,@Nom varchar(100),
...
begin
insert 	into 	CfgCampos(RucE,Id_CTb,Id_TDt,Nom,ValorDef,MaxCarac,IB_Oblig,IB_Hab,MinDate,MaxDate,ValList,Fmla,MaxValue,MinValue)
	values	(@RucE,@Id_CTb,@Id_TDt,@Nom,@ValorDef,@MaxCarac,@IB_Oblig,@IB_Hab,@MinDate,@MaxDate,@ValList,@Fmla,@MaxValue,@MinValue)
end
-- Leyenda --
