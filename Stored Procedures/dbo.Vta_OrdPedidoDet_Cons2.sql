...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Vta_OrdPedidoDet_Cons2]
@RucE nvarchar(11),
@Cd_OP char(10),
...
select  @RucE as RucE,op.Item, op.Cd_OP, op.Cd_Prod, op.Cd_Srv , op.Descrip, op.PU, op.ID_UMP, op.Cant, op.PendEnt, op.Valor, op.DsctoP, op.DsctoI,
	...
	op.CA06, op.CA07, op.CA08, op.CA09, op.CA10, op.Cd_CC, op.Cd_SC, op.Cd_SS,op.ValVtaUnit,op.TotalVtaSD,op.PrecioUnitSD,Prd.CodCo1_
from OrdPedidoDet op
Inner Join Producto2 as Prd On
Prd.RucE = @RucE And op.Cd_Prod = Prd.Cd_Prod
where  op.RucE = @RucE and op.Cd_OP=@Cd_OP
--exec Vta_OrdPedidoDet_Cons2 '11111111111','OP00000017',null
-- Leyenda --
