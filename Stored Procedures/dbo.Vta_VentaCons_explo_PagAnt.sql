...
SET ANSI_NULLS OFF
GO
CREATE procedure [dbo].[Vta_VentaCons_explo_PagAnt]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
--
	...
	declare @Consulta nvarchar(4000)
		set @Consulta='		select *from(
				...
				v.Cd_Mda,mo.Nombre as Moneda, v.CamMda, v.Obs, v.Valor, v.TotDsctoP, v.TotDsctoI, v.ValorNeto, v.BaseSinDsctoF, v.DsctoFnz_P, v.DsctoFnz_I,
				...
				v.INF_Neto, v.EXO_Neto, v.EXPO_Neto, v.BIM_Neto, v.IGV, case(v.IGV) when 0 then 0 else 1 end as IncIGV, v.Total, v.Percep,
