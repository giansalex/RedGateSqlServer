...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_ProdUMConsxProd1]
@RucE nvarchar(11),
@Cd_Prod char(7),
@TipCons int,
...
--begin
if (@TipCons=0)
	select ID_UMP,UM.Cd_UM,descripAlt,Factor,Nombre,NCorto,Estado,PesoKg , volumen from Prod_UM as PUM inner join UnidadMedida as UM on PUM.Cd_UM = UM.Cd_UM and UM.Estado= 1 and Cd_Prod=@Cd_Prod and RucE=@RucE
else if (@TipCons=1)
