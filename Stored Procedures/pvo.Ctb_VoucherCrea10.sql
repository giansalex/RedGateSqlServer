...
CREATE procedure [pvo].[Ctb_VoucherCrea10] --Modificacion: 10d V2
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
*/
	...
	begin
		if exists (select * from Voucher where RucE=@RucE and Cd_TD=@Cd_TD and isnull(NroSre,'') = @NroSre and NroDoc=@NroDoc and Cd_Fte='RV') and @Cd_Fte!='CB' and @Cd_Fte!='LD' -- cuando sea una cancelacion no comprobamos nrodoc ya que pueden haber varias cancelaciones
		begin	--set @msj = 'Ya existe un registro con el mismo tipo, serie y numero de documento para dicho auxiliar.'
...
*/
	...
	begin
		...
		exec pvo.Ctb_VoucherInsert5 @RucE, @Ejer, @Prdo, @RegCtb, @Cd_Fte, @FecMov, @FecCbr, @NroCta, /*@Cd_Aux*/ @Cd_Clt, @Cd_Prv, @Cd_TD, @NroSre,
