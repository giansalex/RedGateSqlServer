...
SET ANSI_NULLS ON
GO
CREATE procedure [user321].[Inv_InventarioCons_ExploGen]
@RucE nvarchar(11),
--@Cd_Prod char(7),
@FecD datetime,
@FecH datetime,
...
as
	...
	set @Cond = 'a.RucE=''' + @RucE + ''' and a.FecMov between '''+ convert(nvarchar,@FecD,103)+''' and '''+Convert(nvarchar,@FecH,103)+''''
	...
	Exec (@Consulta)
--Pruebas:
--exec Inv_InventarioCons_ExploGen '11111111111', '01/01/2000','30/11/2050', null, null, 200
