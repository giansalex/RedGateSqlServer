...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_RegistroVentasCtb_X_Usu]
--Reporte de registro de ventas x contabilidad ordenado x Usuario
@RucE nvarchar(11),
@Eje nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
begin
	...
	Begin
		...
		Group by v.RucE,e.RSocial,v.UsuCrea,v.Ejer,v.RegCtb,v.Cd_Fte,v.IB_Anulado--,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc--,v.FecMov,v.Cd_TD,v.NroSre,v.NroDoc--,a.Cd_TDI,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom,v.IB_Anulado
		Order by v.UsuCrea
		...
		Group by v.RucE,e.RSocial,v.UsuCrea,v.RegCtb,v.CamMda,v.IB_Anulado
		Order by v.UsuCrea
	End
	Else
	Begin
...
/* Ejemplo
exec dbo.Rpt_RegistroVentasCtb_X_Usu '11111111111','2010','01','04','01',null
*/
