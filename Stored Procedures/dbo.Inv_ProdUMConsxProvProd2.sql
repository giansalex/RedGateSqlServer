...
SET ANSI_NULLS ON
GO
create procedure [dbo].[Inv_ProdUMConsxProvProd2]
...
as
select CAST(0 as bit) as Sel, T1.ID_UMP, T1.DescripAlt, T1.Nombre, T1.NCorto from 
(select PUM.RucE,PUM.Cd_Prod,PUM.ID_UMP,PUM.descripAlt,UM.Nombre,UM.NCorto, .0000000 as Cost,
PUM.PesoKg as PesoKg from Prod_UM PUM
...
-- CAM: 2011-22-11 : coloque CAST para grilla de devexpress
-- cam 30/06/2012 aumentar decimales a costo
GO
