...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Ctb_VoucherCons4_PagAnt1]
@RucE nvarchar(11),
@Eje nvarchar(4),
@PrdoIni nvarchar(2),
@PrdoFin nvarchar(2),
...
SET CONCAT_NULL_YIELDS_NULL off --Para que se pueda concatenar NULLs --PV 
	...
	vou.Ejer, --Ejericio o aÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±o de registro
	...
	from '+@Inter+'
	where '+@cond+'
	order by Cd_Vou desc)as Voucher order by RucE , Cd_Vou'
