...
SET ANSI_NULLS ON
GO
CREATE Procedure [dbo].[Rpt_VoucherCons_LD2]
--exec Rpt_VoucherCons_LD2 '11111111111','2009','01','02','01','1','0','0','0','0','0','0','0','','',null
@RucE nvarchar(11),
@Ejer nvarchar(4),
@PrdoIni nvarchar(2),
@PrdoFin nvarchar(2),
...
begin
	...
	begin
		Set @CB_Det = ' select
				...
				vou.NroCta,cta.NomCta,''Centra. mes ''+vou.Prdo
