...
SET ANSI_NULLS ON
GO
create procedure [dbo].[Inv_Producto2Crea1]
...
if exists (select * from Producto2 where RucE = @RucE and Nombre1 = @Nombre1)
	...
	begin
		...
		insert into Producto2 (RucE,Cd_Prod,Nombre1,Nombre2,Descrip,NCorto,Cta1,Cta2,CodCo1_,CodCo2_,CodCo3_,CodBarras,FecCaducidad,Img,
			...
			UsuCrea,UsuMdf,FecReg,FecMdf,Estado,CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10,IB_PT,IB_MP,IB_EE,IB_Srs)
			...
			@Cd_CC,@Cd_SC,@Cd_SS,@UsuCrea,null,getdate(),null,1,@CA01,@CA02,@CA03,@CA04,@CA05,@CA06,@CA07,@CA08,@CA09,@CA10,@IB_PT,@IB_MP,@IB_EE,@IB_Srs)
		if @@rowcount <= 0
...
-- FL : 2011-02-24 : <Se agregaron los campos @IB_PT, @IB_MP, @IB_EE, @IB_Srs>
