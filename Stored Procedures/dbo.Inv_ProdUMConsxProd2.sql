...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_ProdUMConsxProd2]
@RucE nvarchar(11),
@Cd_Prod char(7),
...
if(@FecMov is null)
	set @FecMov =getdate()
if (@TipCons=0)
	select CAST(0 as bit) as Sel,ID_UMP,UM.Cd_UM,descripAlt,Factor,Nombre,NCorto,PUM.EstadoUMP,Estado,PesoKg, volumen, [dbo].[CostEnt2](@RucE ,@Cd_Prod , ID_UMP , @FecMov , '01' ) as Cost, [dbo].[CostEnt2](@RucE ,@Cd_Prod , ID_UMP , @FecMov , '02' ) as Cost_ME
