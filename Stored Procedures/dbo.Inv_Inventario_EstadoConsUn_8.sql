...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_Inventario_EstadoConsUn_8]
...
begin
	select * from SolicitudReq where RucE = @RucE and Cd_SR = @Cd_SR 
	and (Id_EstSR in ('01','02','04','05','08') or  Id_EstSRS in ('01','02','04','05','06','10'))
	if(@@ROWCOUNT = 0)
	begin
...
--LEYENDA:
-- CAM <Fecha: 11/07/2011><Creacion del sp> v7
-- MM <Fecha: 13/09/2011><Creacion del sp> v8
