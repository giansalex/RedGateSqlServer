...
exec [user321].[Rpt_Voucher_DAOTRESUM1] '20507417028','2012',null
exec [user321].[Rpt_Voucher_DAOTRESUM] '20538349730','2011',null
*/

CREATE procedure [user321].[Rpt_Voucher_DAOTRESUM1]
@RucE nvarchar(11),
@Ejer varchar(4),
...
--<Creado: JJ:JA> <29/02/2012> select*from voucher
--Prueba: exec [user321].[Rpt_Voucher_DAOTRESUM1] '20501996140','2011',null
GO
