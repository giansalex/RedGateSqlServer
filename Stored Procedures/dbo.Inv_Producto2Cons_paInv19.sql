...
CREATE procedure [dbo].[Inv_Producto2Cons_paInv19]
@RucE nvarchar(11),
@Cd_Com nvarchar(10),
@Cd_Vta nvarchar(10),
@Cd_OC nvarchar(10),
...
begin
	...
	P.IB_Srs, UMP.Factor,null as Cd_IP
	from CompraDet c 
...
-- PARA VENTAS 0.0000000
-- EXEC Inv_Producto2Cons_paInv18 '20538349730',NULL, 'VT00000291', NULL, NULL, NULL, NULL, NULL, '','',''
-- select fecmov from Venta where RucE = '20538349730' and Cd_Vta = 'VT00000291'
--exec dbo.CostSal3 
...
begin  -- MM: VERIFICACION DE SALDO
	select	null as Cd_Com, null as Cd_Vta, null as Cd_OC, null as Cd_OP,null as Cd_GR, null as Cd_TD, null as NroSre, 
			...
			pr.IB_Srs, UMP.Factor,null as Cd_IP
	from (
...
begin
	...
	select distinct
	null as Cd_Com, null as Cd_Vta, @Cd_OC as Cd_OC, null as Cd_OP,null as Cd_GR, @Cd_TD as Cd_TD, @NroSre as NroSre, @NroDoc as NroDoc,
	Item, c.Cd_Prod,P.CodCo1_ as CodCom,null as Cd_Alm,P.Nombre1,P.Descrip,UMP.ID_UMP,UMP.DescripAlt,c.Cant, 
	--isnull((select sum(Cant_Ing) from Inventario i where i.RucE = c.RucE and i.Cd_Com = c.Cd_Com and i.Cd_Prod=c.Cd_Prod and i.Item = c.Item),0 )as Cant_Ing,
...
-- CAM <Fecha: 29/08/2012><Creacion del sp>


-- PARA COMPRAS
-- exec Inv_Producto2Cons_paInv17 '20538349730','CM00000090',null,null,null,null,null,null,'','',''
-- PARA VENTAS
-- EXEC Inv_Producto2Cons_paInv18 '20538349730',NULL, 'VT00000291', NULL, NULL, NULL, NULL, NULL, '','',''
...
-- PARA GUIA REMISION
-- Compra: exec Inv_Producto2Cons_paInv16 '11111111111',null,null,null,null,'GR00000084','',null,'',''
-- Venta : exec Inv_Producto2Cons_paInv16 '11111111111',null,null,null,null,'GR00000083','',null,'',''
-- PARA SOLICITUD DE REQUERIMIENTO
-- exec Inv_Producto2Cons_paInv18 '11111111111',null,null,null,null,null,'SR00000167',null,'','',''
-- PARA ORDEN DE FABRICACION
-- exec Inv_Producto2Cons_paInv16 '11111111111',null,null,null,null,null,null,'OF00000001','',''
-- PARA IMPORTACION
-- exec Inv_Producto2Cons_paInv16 '11111111111',null,null,null,null,null,null,null,'IP00001',''
/*
select * from Inventario where RucE = '20538349730' and Cd_Vta = 'VT00000278'
*/
GO
