...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_RegistroVentasCtb_X_RegCtb]
--Reporte de registro de ventas x contabilidad ordenado x registro contable
@RucE nvarchar(11),
@Eje nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
begin
	select 
		...
		,'' as FecR,'' as TDR,'' as NSreR,'' as NDocR, '' as DR_NCND, '' as DR_NroDet, '' as DR_FecDet
...
begin
	...
	Begin
		select 
			...
			v.DR_NCND,v.DR_NroDet,v.DR_FecDet
		...
		Group by v.RucE,e.RSocial,v.Ejer,v.RegCtb,v.Cd_Fte,v.IB_Anulado,v.DR_NCND,v.DR_NroDet,v.DR_FecDet--,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc--,v.FecMov,v.Cd_TD,v.NroSre,v.NroDoc--,a.Cd_TDI,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom,v.IB_Anulado
		Order by 3
...
-- J -> 21/07/2010 MODIFICACION agregar columnas para la provision
/*--Ejemplo--*/
--exec Rpt_RegistroVentasCtb_X_RegCtb '11111111111','2010','01','06','01',null

--MP: LUN 20-09-2010 Modf: Se quito las referencias a la tabla Auxliar y se enlazo con Cliente2
--CM: RA01
GO
