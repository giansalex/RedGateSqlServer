...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_RegistroVentasCtb_X_Sr]
--Reporte de registro de ventas x contabilidad ordenado x Serie
@RucE nvarchar(11),
@Eje nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
begin
	...
	Begin
		...
		Group by v.RucE,e.RSocial,v.NroSre,v.Ejer,v.RegCtb,v.Cd_Fte,v.IB_Anulado--,v.DR_FecED,v.DR_CdTD,v.DR_NSre,v.DR_NDoc--,v.FecMov,v.Cd_TD,v.NroSre,v.NroDoc--,a.Cd_TDI,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom,v.IB_Anulado
		Order by v.NroSre
		...
		Group by v.RucE,e.RSocial,v.NroSre,v.RegCtb,v.CamMda,v.IB_Anulado
		Order by v.NroSre
	End
	Else
	Begin
...
/* Ejemplo
exec dbo.Rpt_RegistroVentasCtb_X_Sr '11111111111','2010','01','04','01',null
*/

--MP: LUN 20-09-2010 Modf: Se quito las referencias a la tabla Auxiliar y se enlazon con Cliente2
--CM: RA01
GO
