...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Vta_Venta2Mdf4]
@RucE nvarchar(11), --
@Cd_Vta nvarchar(10), -- 
@Eje nvarchar(4), --
@Prdo nvarchar(2), --
...
-----verificar si esta cerrado el periodo
	...
	set @msj = 'Venta no puede ser Modificada, el periodo '+User123.DamePeriodo(SubString((select regctb from venta where ruce=@RucE and Cd_Vta=@Cd_Vta),8,2))+' no se encuentra habilitado'
-----
else
begin
