...
CREATE  Procedure [dbo].[Rpt_Venta_Kaeser]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@Cd_Vta nvarchar(10),
...
begin
		...
		select 
			...
			vta.Cd_Vta,vta.Cd_OP,gv.Cd_GR, vta.Eje,vta.Prdo,vta.RegCtb,
	...
	------------------------------------------------
		...
		select 
			...
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA01 else pr.CA01 end as CA01PrSrv,--Campo adicional 1
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA02 else pr.CA02 end as CA02PrSrv,--Campo adicional 2
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA03 else pr.CA03 end as CA03PrSrv,--Campo adicional 3
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA04 else pr.CA04 end as CA04PrSrv,--Campo adicional 4
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA05 else pr.CA05 end as CA05PrSrv,--..5
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA06 else pr.CA06 end as CA06PrSrv,--..6
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA07 else pr.CA07 end as CA07PrSrv,--..7
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA08 else pr.CA08 end as CA08PrSrv,--..8
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA09 else pr.CA09 end as CA09PrSrv,--..9
			case(IsNull(det.Cd_Prod,'0')) when '0' then srv.CA10 else pr.CA10 end as CA10PrSrv,--..10
			/*********************************************************************************************/
...
print @msj
-- Leyenda --
-- JA : 2011-02-23 	: <Creacion del procedimiento almacenado>
--exec Rpt_Venta_Kaeser '111111111111','2010','VT00000349',null
