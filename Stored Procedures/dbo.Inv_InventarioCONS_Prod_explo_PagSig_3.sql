...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_InventarioCONS_Prod_explo_PagSig_3]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
-- Leyenda --
-- CAM : 28/12/2011 	: <Creacion del procedimiento almacenado>
-- exec Inv_InventarioCONS_Prod_explo_PagSig_3 '11111111111','01/12/2011','28/12/2011',null,null,50,null,null,null,null,null,null
--select * from Moneda
GO
