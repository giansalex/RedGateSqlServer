...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Vta_CotizacionVtaDet_Cons_paOP]
@RucE nvarchar(11),
@Cd_Cot char(10),
...
case(isnull(ct.IGV,0)) when 0 then 0 else 1 end as IncIGV , ct.IGV, ct.Total, ct.Obs, ct.Cd_CC, ct.Cd_SC, ct.Cd_SS
