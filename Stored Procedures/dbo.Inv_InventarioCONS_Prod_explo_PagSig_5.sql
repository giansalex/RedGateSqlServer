...
CREATE procedure [dbo].[Inv_InventarioCONS_Prod_explo_PagSig_5]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
---
	...
	declare @Consulta nvarchar(4000)
		set @Consulta='		select top '+convert(nvarchar,@TamPag)+'
				...
				--Abs(Inv.CosUnt) as CosUnt,
				--Abs(Inv.Total) as Total,
				Inv.Cd_Gr,
...
-- exec Inv_InventarioCONS_Prod_explo_PagSig_5 '20546110729','01/02/2012','28/02/2012','Cd_SS','%C#1 - CONTENEDOR # 1%',500,null,null,null,null,null,null
