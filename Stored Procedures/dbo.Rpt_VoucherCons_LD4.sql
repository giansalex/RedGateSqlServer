...
CREATE Procedure [dbo].[Rpt_VoucherCons_LD4]
...
set @ConsIni='select RucE,RSocial, Cd_Fte,RegCtb,Prdo,FecReg,NroCta,NomCta,Cd_Aux,NomAux,TD,DCTO,Glosa,Sum(Debe) Debe, Sum(Haber) Haber 
			from ('
set @ConsFin=') as Cons 
			Group By RucE,RSocial, Cd_Fte,RegCtb,Prdo,FecReg,NroCta,NomCta,Cd_Aux,NomAux,TD,DCTo,Glosa
			'
