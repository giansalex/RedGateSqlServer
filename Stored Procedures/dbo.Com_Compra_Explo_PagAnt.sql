...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_Compra_Explo_PagAnt]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
as
	...
	begin
		set @Cond = 'co.RucE= '''+@RucE+''' and co.FecMov between '''+
	...
	set @Consulta=	'
		       ...
		       , ar.Descrip as Area, co.Cd_CC, co.Cd_SC, co.Cd_SS, co.BIM_S, co.IGV_S, co.BIM_E, co.IGV_E,co.BIM_C, co.IGV_C,co.Imp_N,co.Imp_O, co.Total, co.CamMda, co.Cd_MIS
		       , mis.Descrip as MtvoIngSal, co.Cd_OC, co.IB_Pgdo, co.IB_Anulado, co.DR_NCND, co.DR_NroDet
		       ...
		       , co.CA06, co.CA07, co.CA08, co.CA09, co.CA10,md.Nombre as Cd_Mda, Convert(nvarchar,co.FecReg,103) as FecReg,co.UsuCrea, Convert(nvarchar,co.FecMdf,103) FecMdf,co.UsuModf
