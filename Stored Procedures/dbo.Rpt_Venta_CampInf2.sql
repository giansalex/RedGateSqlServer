...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_Venta_CampInf2]
@RucE nvarchar(11),
@Eje nvarchar(4),
@Cd_Vta nvarchar(10),
...
set @CampoInsp = (select Valor from CampoV where RucE=@RucE and Cd_Vta=@Cd_Vta and Cd_Cp='01')
	...
	Group by ve.RucE,em.RSocial,em.Direccion,ca.Cd_Aux,ca.Cd_TDI,ti.Descrip,ca.NDoc,ca.ApPat,
		...
		ve.Total,ve.CamMda,ve.FecMov,ve.UsuCrea,ve.DR_CdTD,ve.DR_NSre,ve.DR_NDoc,ve.Cd_Vdr,va.ApPat,va.ApMat,va.Nom,va.RSocial,ve.Cd_TD,td.Descrip,ve.NroDoc,ve.Cd_Area,ar.NCorto,ve.Cd_Mda,mo.Simbolo,mo.Nombre
