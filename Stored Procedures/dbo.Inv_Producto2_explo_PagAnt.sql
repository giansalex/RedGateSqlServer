...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_Producto2_explo_PagAnt]--<Mantenimiento de Producto2>
@RucE nvarchar(11),
@TamPag int,
@Ult_Prod nvarchar(7),
...
as
	...
	set @Consulta = 
	'select *from (select top '+Convert(nvarchar,@TamPag)+' a.RucE,a.Cd_Prod,a.Nombre1,a.Nombre2,a.NCorto,a.Descrip,a.Cta1,a.Cta2,a.CodCo1_,a.CodCo2_,a.CodCo3_,
	...
	a.Cd_CGP,a.UsuCrea,a.UsuMdf,a.FecReg,a.FecMdf,a.Estado,a.CA01,a.CA02,a.CA03,a.CA04,a.CA05,a.CA06,a.CA07,a.CA08,a.CA09,a.CA10,a.IB_Srs from 
	'+@Inter+' where '+@Cond+' order by a.Cd_Prod desc) as Producto order by Cd_Prod'
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---final --> consulta productos pagina anterior
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---inicio --> obtenemos el registro mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ximo & mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­nimo de productos //ordenado por : Cd_Prod
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	---final --> obtenemos el registro mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ximo & mÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â­nimo de productos //ordenado por : Cd_Prod
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
exec Inv_Producto2_explo_PagAnt '11111111111',5,'PD00040',@Max out,@Min out,null
*/
