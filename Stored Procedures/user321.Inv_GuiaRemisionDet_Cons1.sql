...
SET ANSI_NULLS ON
GO
create proc [user321].[Inv_GuiaRemisionDet_Cons1]
@RucE nvarchar(11),
@Cd_GR char(10),
...
as
	select @PesoxCant = 1
	select GRD.Cd_GR,GRD.Item, P.Cd_Prod, P.CodCo1_, P.Nombre1,UM.Nombre,PU.DescripAlt,GRD.Cd_Vta,GRD.Cd_Com,GRD.ItemPd,GRD.Pend,GRD.Cant,@PesoxCant as PesoxCant,GRD.PesoCantKg,GRD.ID_UMP,GRD.CA01,GRD.CA02,GRD.CA03,GRD.CA04,GRD.CA05,GRD.Descrip,isnull(GRD.Pend,0)+Cant as 'Maximo'  from Producto2 as P inner join 
...
-- CAM : 2011-11-17 colocar cod comercial
-- exec user321.Inv_GuiaRemisionDet_Cons '11111111111','GR00000183',0,0,''
