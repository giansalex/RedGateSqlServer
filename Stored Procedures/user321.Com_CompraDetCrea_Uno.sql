...
SET ANSI_NULLS OFF
GO
CREATE procedure [user321].[Com_CompraDetCrea_Uno]
@RucE nvarchar(11),
@Cd_Com char(10),
@Item int,
@Cd_Prod char(7),
...
@PU_New numeric (13,2),
@Cant numeric(13,3),
@IMP_New numeric(13,2),
@IGV_New numeric(13,2),
@Total numeric(13,2),
@Cd_IA char(1),
@Cd_CC nvarchar(8),
@Cd_SC nvarchar(8),
...
begin
	...
	insert into CompraDet(RucE,Cd_Com,Item,Cd_Prod,Cd_Srv,Descrip,ID_UMP,PU_New,Cant,IMP,IMP_New,IGV_New,Total,Cd_IA,
				 Cd_CC,Cd_SC,Cd_SS,Cd_Alm,Obs,FecMdf,UsuModf,CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10)
			values(@RucE,@Cd_Com,@Item,@Cd_Prod,@Cd_Srv,@Descrip,@ID_UMP,@PU_New,@Cant,0.00,@IMP_New,@IGV_New,@Total,
...
begin
	...
	insert into ProdProvPrecio(RucE,ID_PrecPrv,Cd_Prv,Cd_Prod,ID_UMP,Fecha,PrecioCom,IB_IncIGV,Cd_Mda,Obs,Estado)
			values(@RucE,@Id_PrecPrv,@Cd_Prv,@Cd_Prod,@ID_UMP,GETDATE(),@PrecioCom,case(isnull(@IGV_New,0))
...
begin
	...
	insert into ServProvPrecio(RucE,ID_PrecSP,Cd_Prv,Cd_Srv,Fecha,PrecioCom,IB_IncIGV,Cd_Mda,Estado)
			values(@RucE,@ID_PrecSP,@Cd_Prv,@Cd_Srv,GETDATE(),@PrecioCom,case(isnull(@IGV_New,0))
