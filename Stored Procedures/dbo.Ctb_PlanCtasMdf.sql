...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Ctb_PlanCtasMdf]
@RucE nvarchar(11),
@NroCta nvarchar(10),
@NomCta varchar(50),
@Nivel int,
...
begin
	update PlanCtas set NomCta=@NomCta, Nivel=@Nivel, IB_Aux=@IB_Aux, IB_CC=@IB_CC, IB_DifC=@IB_DifC, 
                            ...
                            IB_CtaD=@IB_CtaD,Estado=@Estado -- IB_MdVta=@IB_MdVta, IB_MdCom=@IB_MdCom, IB_MdCtb=@IB_MdCtb, IB_MdTsr=@IB_MdTsr, IB_MdPrs=@IB_MdPrs, IB_MdInv=@IB_MdInv, Cd_Blc=@Cd_Blc, Cd_EGPN=@Cd_EGPN, Cd_EGPF=@Cd_EGPF,
