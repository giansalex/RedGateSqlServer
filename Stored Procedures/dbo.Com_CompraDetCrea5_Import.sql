...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_CompraDetCrea5_Import]
@RucE nvarchar(11),
@Cd_Com char(10),
@Item int,
@Cd_Prod char(7),
...
if not exists(select * from Compra where RucE=@RucE and Cd_Com=@Cd_Com) and (isnull(@Cd_Com, '') <> '') 
	begin
		Set @msj = 'No existe codigo de Compra ' + @Cd_Com
		return 
	end
...
------------------
	...
	Set @msj = 'Ya existe numero Item de detalle de compra'
else
begin
