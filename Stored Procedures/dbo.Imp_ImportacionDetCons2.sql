...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Imp_ImportacionDetCons2] 
@RucE nvarchar(11),
@Cd_IP char(7),
@msj varchar(100) output
as
	select i.RucE,i.Cd_IP, p.CodCo1_ as CodCo,i.Item,i.Cd_Prod,i.ID_UMP,i.Cd_Com,c.RegCtb,i.ItemCP,i.Cant,i.PesoKg,i.Volumen,
...
--exec Imp_ImportacionDetCons2 '11111111111','IP00050',null
