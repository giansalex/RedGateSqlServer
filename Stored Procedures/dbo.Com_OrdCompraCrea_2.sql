...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Com_OrdCompraCrea_2]
...
begin 
	insert into OrdCompra(RucE,Cd_OC,NroOC,FecE,FecEntR,Cd_FPC,Cd_Area,Cd_Prv,Obs,Valor,TotDsctoP,TotDsctoI,ValorNeto,
				...
				Cd_SC,Cd_SS,Id_EstOC,TipAut, IB_Aut, CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10,Asunto,CA11,CA12,CA13,CA14,CA15)
			values(@RucE,@Cd_OC,@NroOC,@FecE,@FecEntR,@Cd_FPC,@Cd_Area,@Cd_Prv,IsNull(@Obs,''),@Valor,@TotDsctoP,@TotDsctoI,@ValorNeto,
				...
				@Cd_SC,@Cd_SS,'01',isnull(@TipAut,0),0,@CA01,@CA02,@CA03,@CA04,@CA05,@CA06,@CA07,@CA08,@CA09,@CA10,@Asunto,@CA11,@CA12,@CA13,@CA14,@CA15)
	if @@rowcount <= 0
