...
SET ANSI_NULLS ON
GO
--exec [Rpt_VoucherCons_F5] '11111111111','2012','CPGE_RC05-00001','CPGE_RC05-00001',1,'0',null
CREATE procedure [dbo].[Rpt_VoucherCons_F5] --procedimiento final de la consulta de vouchers para imprimir en reporte
@RucE nvarchar(11),
@Ejer nvarchar(4),
@RegCtb1 nvarchar(15),
@RegCtb2 nvarchar(15),
...
select
	...
	,case when v.Ib_EsDes<> 0 then '01' else '00' end As IB_esDes
	,@SumaDestino as SumaDestino
from Voucher v
