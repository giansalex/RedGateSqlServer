...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Com_Compra_Explo_PagSig2]
...
as
	...
	set @Consulta = 'select top ' +Convert(nvarchar,@Tampag)+'	
			...
			co.Cd_Com, co.RegCtb, co.Ejer, co.Prdo, co.Cd_Prv,
			 ...
			 , ar.Descrip as Area, co.Cd_CC, co.Cd_SC, co.Cd_SS, co.BIM_S, co.IGV_S, co.BIM_E, co.IGV_E,co.BIM_C, co.IGV_C,co.Imp_N,co.Imp_O, co.Total, md.Nombre as Cd_Mda, co.CamMda, co.Cd_MIS
			 , mis.Descrip as MtvoIngSal,mis.Cd_Mis, co.Cd_OC, case co.IB_Pgdo when 1 then 1 else 0 end as IB_Pgdo, co.IB_Anulado, co.DR_NCND, co.DR_NroDet
...
-- PP : 2011/02/18: <Modificacion el en  where>
...
--exec Com_Compra_Explo_PagSig '20504743561','01/02/2011','01/03/2011',null,null,50,'CM00000144',null,null,null,null,null
