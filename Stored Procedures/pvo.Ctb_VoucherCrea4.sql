...
SET ANSI_NULLS ON
GO
CREATE procedure [pvo].[Ctb_VoucherCrea4]
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
--				else set @Mto=@MtoH
				...
				--begin exec pvo.Ctb_VoucherMdf_Mto @RucE,@Ejer,@Prdo,@RegCtb,@MtoDest,@MtoH,@NroCta,@Cd_MdRg,@CamMda,@IC_CtrMd,@Msj output end
				...
				--begin exec pvo.Ctb_VoucherMdf_Mto @RucE,@Ejer,@Prdo,@RegCtb,@MtoD,@MtoDest,@NroCta,@Cd_MdRg,@CamMda,@IC_CtrMd,@Msj output end
