...
SET ANSI_NULLS ON
GO
CREATE Procedure [user321].[Inv_Serial_Explo_PagAnt2]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@Colum varchar(100),
...
begin
	Set @Consulta =' Select *from (
		...
		from '+@Inter+ ' Where '+@Cond + ' and Serial in (select serial from serialmov where ruce='+@RucE+' )' +' Order by Siguient Desc) as Serial Order by Siguient'
...
exec user321.Inv_Serial_Explo_PagAnt2 '11111111111','01/06/2012','30/06/2012',null,null,2,'PD00084A0001',null,null,true,null
*/
