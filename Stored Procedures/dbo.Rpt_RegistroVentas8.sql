...
SET ANSI_NULLS ON
GO
--[dbo].[Rpt_RegistroVentas8] '20536657135','2013','02','02','01','Asc',0,01,1,null
-- exec [dbo].[Rpt_RegistroVentas8] '20160000001','2016','10','10','01','Asc',0,01,1,null





CREATE procedure [dbo].[Rpt_RegistroVentas8]
@RucE nvarchar(11),
@Eje nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
set @Consulta3='
		...
		Group by v.RucE,v.RegCtb,v.Cd_MdRg, v.CamMda,v.IB_Anulado
		) as t1 on t1.RucE=t.RucE and t1.RegCtb=t.RegCtb
		Order By
		'
...
--PV, GG: 17/11/2016>: Se agrego campo Cd_MdRg en la consulta para exportacion de PLE Venta
GO
