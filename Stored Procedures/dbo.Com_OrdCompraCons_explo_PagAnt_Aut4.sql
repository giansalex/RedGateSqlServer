...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Com_OrdCompraCons_explo_PagAnt_Aut4]
...
as
	...
	join(
		...
		where oc.RucE = '''+@RucE+''' and (IB_Aut is null or IB_Aut = 0) and TipAut !=0
...
-- LEYENDA
-- CAM 19/05/2011 Se agrego centro de costos
-- CAM 31/05/2011 Se agrego UsuCrea
-- CAM 10/08/2011 Estado Servicio
GO
