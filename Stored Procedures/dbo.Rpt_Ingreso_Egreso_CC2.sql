...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_Ingreso_Egreso_CC2]
...
Set @RucE='20452574528' Set @Ejer='2010'
Set @PrdoIni='02' Set @PrdoFin='02'
Set @Nivel1='1' Set @Nivel2='0' Set @Nivel3='0' Set @Nivel4='1'
Set @Cd_Mda='01'
Set @Opc = 'N'
Set @Datos = '''E'',''D'',''C'',''B'',''A'',''30'',''20'',''10'',''01010101'''
*/
--*********************************************************
...
Set @SQL3_2 =
	...
	begin	Set @Part11_N1 = '' Select 1 as ind,Tem.NroCta,Tem.NomCta''
		Set @Part21_N1 = ''	,'''''''' as Total
				...
				Inner Join Voucher v On v.RucE=''''''+@RucE+'''''' and v.Ejer=''''''+@Ejer+'''''' and v.Prdo between ''''''+@Prdo1+'''''' and ''''''+@Prdo2+'''''' and left(v.NroCta,2)=Tem.NroCta and v.IB_Anulado=0
...
Set @SQL4_1 =
	...
	begin	if(@N1 = ''1'')
		...
		Set @Part21_N2 = ''	,'''''''' as Total
				...
				Inner Join Voucher v On v.RucE=''''''+@RucE+'''''' and v.Ejer=''''''+@Ejer+'''''' and v.Prdo between ''''''+@Prdo1+'''''' and ''''''+@Prdo2+'''''' and left(v.NroCta,4)=Tem.NroCta and v.IB_Anulado=0
				Group by Tem.NroCta,Tem.NomCta
			      	''
...
Set @SQL4_2 =
	...
	begin
		...
		Set @Part21_N3 = ''	,'''''''' as Total
				...
				Inner Join Voucher v On v.RucE=''''''+@RucE+'''''' and v.Ejer=''''''+@Ejer+'''''' and v.Prdo between ''''''+@Prdo1+'''''' and ''''''+@Prdo2+'''''' and left(v.NroCta,6)=Tem.NroCta and v.IB_Anulado=0
				Group by Tem.NroCta,Tem.NomCta
			      	''	
...
Set @SQL5_1 = 
	...
	begin
		...
		Set @Part21_N4 = ''	,'''''''' as Total
				From (select p.NroCta,p.NomCta from PlanCtas p where p.RucE=''''''+@RucE+'''''' and p.Ejer=''''''+@Ejer+'''''' and len(p.NroCta)>6 and p.IC_IE''+@Opc+''=''''I'''' Group by p.NroCta,p.NomCta) As Tem
				Inner Join Voucher v On v.RucE=''''''+@RucE+'''''' and v.Ejer=''''''+@Ejer+'''''' and v.Prdo between ''''''+@Prdo1+'''''' and ''''''+@Prdo2+'''''' and v.NroCta=Tem.NroCta and v.IB_Anulado=0
				Group by Tem.NroCta,Tem.NomCta
			      	''
	'
