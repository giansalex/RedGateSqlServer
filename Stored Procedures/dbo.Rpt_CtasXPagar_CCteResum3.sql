...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_CtasXPagar_CCteResum3]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@NroCta1 nvarchar(10),
@NroCta2 nvarchar(10),
...
begin
	...
	where v.RucE=@RucE and v.Ejer=@Ejer and (v.NroCta between @NroCta1 and @NroCta2) and p.IB_CtasXPag=1 and v.IB_Anulado<>'1' and convert(varchar,v.FecMov,102) <= convert(varchar,@FechaAl,102) and v.Cd_Aux=@Cd_Aux
...
begin
	...
	where v.RucE=@RucE and v.Ejer=@Ejer and (v.NroCta between @NroCta1 and @NroCta2) and p.IB_CtasXPag=1 and v.IB_Anulado<>'1' and convert(varchar,v.FecMov,102) <= convert(varchar,@FechaAl,102)
	group by v.RucE,a.NDoc,a.RSocial,a.ApPat,a.ApMat,a.Nom
	having sum(v.MtoD)-sum(v.MtoH)<>0
	order by a.RSocial,a.ApPat,a.ApMat,a.Nom
