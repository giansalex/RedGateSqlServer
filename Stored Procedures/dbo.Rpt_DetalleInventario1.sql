...
CREATE Procedure [dbo].[Rpt_DetalleInventario1]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@FecHasta datetime,
@Cd_Prod nvarchar(10)
...
,isnull(gr.NroSre+'-'+gr.NroGR,isnull(i.NroSre+'-'+i.NroDoc,isnull(c.NroSre+'-'+c.NroDoc,'--'))) as  GuiaFactura
,l.Cd_Lote
,l.NroLote
,l.FecCaducidad
,l.FecFabricacion
...
left join Compra c on c.Cd_OC = i.Cd_OC
where 
i.RucE = @RucE 
...
,isnull(gr.NroSre+'-'+gr.NroGR,isnull(i.NroSre+'-'+i.NroDoc,isnull(c.NroSre+'-'+c.NroDoc,'--')))
