...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Tsr_ConcBanCons_Pend_Dep2]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@NroCta nvarchar(10),
@Prdo nvarchar(2),
...
Begin
	...
	where 
		/*
		v.RucE=@RucE and v.Ejer<=@Ejer and v.NroCta=@NroCta and v.IB_Anulado<>1 and v.Prdo not in ('00','13','14') and
...
-- Leyenda --
-- exec [Tsr_ConcBanCons_Pend_Det2] '20100977037','2011','10.4.1.11','11','1','01',null
