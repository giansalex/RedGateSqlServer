...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Gsp_BancoCons_1]
@RucE nvarchar(11),
@Ejer varchar(4),
@TipCons int,
...
begin
	...
	begin
		select b.Itm_BC, b.RucE,ef.Nombre as 'NombBanco', b.NroCta, b.NCtaB, b.NCorto, m.Nombre as 'Moneda', b.Estado 
		from Banco b 
			inner join Moneda m on m.Cd_Mda=b.Cd_Mda
			inner join EntidadFinanciera ef on ef.Cd_EF=b.Cd_EF			 
		where b.RucE=@RucE and b.Ejer=@Ejer 
