...
SET ANSI_NULLS ON
GO
CREATE procedure [user321].[Com_CompraConsUnxMBL_Flete]
@RucE nvarchar(11),
@MBL varchar(100),
@msj varchar(100) output
as

if not exists (select top 1 *from Compra where RucE = @RucE and CA01 = @MBL and CA16 = 'Flete')
	set @msj='No se encontro Fletes'
else
begin
