...
SET ANSI_NULLS ON
GO
create procedure [pvo].[Ctb_VoucherInsert5_BiMda] --(se esta usando para registros(voucher) manuales)
@RucE		nvarchar(11),
--@Cd_Vou	int,
@Ejer		nvarchar(4),
@Prdo		nvarchar(2),
...
@IB_EsBiMda	bit, -- Indicador para saber si se toman ambas monedas y no se convierten.
------------------------------
