...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_Consultar_Saldos_OC3]
@RucE varchar(11),
@Cd_OC char(10),
@TipoDet int,
...
begin
	select	ocd.Item, ocd.Cd_Prod as 'Cd_Det', pd.Nombre1 as 'Nombre', pd.Descrip as 'Descripcion' , pum.ID_UMP, 
			...
			oc.Cd_CC, oc.Cd_SC, oc.Cd_SS, ocd.Obs, ocd.CA01, ocd.CA02, ocd.CA03, ocd.CA04, ocd.CA05,ocd.BIMTot,ocd.IGVTot
	from (
...
begin
	select	ocd.Item, ocd.Cd_Srv as 'Cd_Det', sr.Nombre as 'Nombre', sr.Descrip as 'Descripcion', ocd.PU, t2.Total as 'TotalC', t2.Saldo, 
			...
			ocd.Total, ocd.Cd_Alm, oc.Cd_CC, oc.Cd_SC, oc.Cd_SS, ocd.Obs, ocd.CA01, ocd.CA02, ocd.CA03, ocd.CA04, ocd.CA05,ocd.BIMTot,ocd.IGVTot
	from (
...
begin
	...
	(
		Cd_Prod char (7),
		Cd_Srv char (7),
		Total numeric(14,9),--NO SE XQ FUNCIONA -- CAM
		Saldo numeric(14,9),--NO SE XQ FUNCIONA -- CAM
		Item int
	)
...
/*	exec Inv_Consultar_Saldos_OC '11111111111','OC00000247',0,null
	...
	exec Inv_Consultar_Saldos_OC2 '11111111111','OC00000247',2,null
*/
GO
