...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_ProdUMModificar_3]
@RucE nvarchar(11),
@Cd_Prod char(7),
@Id_UMP int,
@Cd_UM char(2),
...
begin
      ...
      update Prod_UM set Cd_UM=@Cd_UM,DescripAlt=@DescripAlt,Factor=@Factor,PesoKg=@PesoKg, Volumen=@Volumen, EstadoUMP=@EstadoUMP, IB_UMPPrin=@IB_UMPPrin
