...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Vta_ServCons2]
@RucE nvarchar(11),
@TipCons int,
...
begin
	if(@TipCons=0)
	begin
		select a.RucE,a.Cd_Pro as Cd_Srv,a.CodCo,b.Cd_GS,a.Nombre,a.Descrip,a.Cta1,a.Cta2,a.PrecioVta,a.IB_IncIGV,a.ValorVta,
		          case(a.IC_TipDcto)
			when 'I' then 'Importe'
