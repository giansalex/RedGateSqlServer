...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Com_CompraCrea3]
@RucE nvarchar(11),
...
begin 
	insert into Compra(RucE,Cd_Com,Ejer,Prdo,RegCtb,FecMov,Cd_FPC,FecApag,Cd_TD,NroSre,NroDoc,FecED,FecVD,Cd_Prv,
			   ...
			   CA07,CA08,CA09,CA10,CA11,CA12,CA13,CA14,CA15,CA16,CA17,CA18,CA19,CA20,CA21,CA22,CA23,CA24,CA25,TipNC)
			values(@RucE,@Cd_Com,@Ejer,@Prdo,@RegCtb,@FecMov,@Cd_FPC,@FecApag,@Cd_TD,@NroSre,@NroDoc,@FecED,
			       ...
			       @CA19,@CA20,@CA21,@CA22,@CA23,@CA24,@CA25, @TipNC)
	if @@rowcount <= 0
