...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Rpt_Venta_CampInf]
@RucE nvarchar(11),
@Eje nvarchar(4),
@Cd_Vta nvarchar(10),
...
set @CampoInsp = (select Valor from CampoV where RucE=@RucE and Cd_Vta=@Cd_Vta and Cd_Cp='01')
	...
	select 
	       --Datos Producto--
               de.Cd_Pro, pr.Nombre as NomPro,pr.CodCo,de.Cd_Vta,
	       --Datos Detalle Venta--
	       ...
	       Nro_RegVdt as NroPro,CA01,CA02,CA03,CA04,CA05,CA06
		...
		--INFORMACION ADICIONADA
	       --CAMPOS INFORMATIVOS
			...
			/*CAMPO INFORMATIVO 03*/
				...
				when 0 
				then '0' 
				else convert(varchar(50),convert(int,CA03,103),103) end as CA03,
			/*CAMPO INFORMATIVO 04*/
				case(isnull(len(CA04),0)) 
				when 0 
				then '0' 
				else convert(varchar(50),convert(float,CA04,103),103) end as CA04,
			/*CAMPO INFORMATIVO 05*/
				case(isnull(len(CA05),0)) 
				when 0 
				then '0' 
				else convert(varchar(50),convert(int,CA05,103),103) end as CA05,
			/*CAMPO INFORMATIVO 06*/
				case(isnull(len(CA06),0)) 
				when 0 
				then '0' 
				else convert(varchar(50),convert(int,CA06,103),103) end as CA06,
			...
			/*CAMPO INFORMATIVO 10*/
				...
				when 0 
				then '0' 
				else convert(varchar(50),convert(float,CA10,103),103) end as CA10	
            -------------------------------------------------------------------------------------------------------	       
	from VentaDet de, Producto pr, UnidadMedida um, Servicio se, GrupoSrv gr
	where de.RucE=@RucE and de.Cd_Vta=@Cd_Vta and 
	      de.RucE=pr.RucE and de.Cd_Pro=pr.Cd_Pro and
	...
	Select de.Cd_Vta,de.Nro_RegVdt as NroPro,de.Cd_Pro,
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA01
	--Having CA01 <> ' ' 
	--Union All 
	Union
	/*------------------CAMPO INFORMATIVO 02------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA02
	--Having CA02 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 03------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA03
	--Having CA03 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 04------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA04
	--Having CA04 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 05------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA05
	--Having CA05 <> ' ' 
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 06------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA06
	--Having CA06 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 07------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA07
	--Having CA07 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 08------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA08
	--Having CA08 <> ' '
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA09
	--Having CA09 <> ' '
	--Union All
	Union
	/*------------------CAMPO INFORMATIVO 10------------------*/
	...
	Group by de.Cd_Vta,de.Nro_RegVdt,de.Cd_Pro,de.CA10
	--Having CA10 <> ' '
	)
