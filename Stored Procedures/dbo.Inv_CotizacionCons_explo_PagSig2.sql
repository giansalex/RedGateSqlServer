...
SET ANSI_NULLS ON
GO
CREATE proc [dbo].[Inv_CotizacionCons_explo_PagSig2]
...
--select * from Cotizacion c where RucE = '11111111111' and ((c.TipAut = 0 or c.TipAut is null) or (c.IB_Aut = 1))
...
-- MM : 06/06/2011 <SE AGREGO LOS CAMPOS DE AUTORUIZACION>
