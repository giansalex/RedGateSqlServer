...
SET ANSI_NULLS ON
GO
CREATE procedure [user321].[Rpt_OCPendientes]
@RucE nvarchar(11),
@FecD datetime,
@FecH datetime,
@EstadoOC char(1),
...
where oc.RucE='''+@RucE+''' and oc.FecE between '''+convert(nvarchar,@FecD,103)+ ''' and '''+convert(nvarchar,@FecH,103)+''') as OCD 
...
where co.RucE='''+@RucE+''' and FecMov between '''+convert(nvarchar,@FecD,103)+ ''' and '''+convert(nvarchar,@FecH,103)+''') as COM  on COM.RucE=OCD.RucE and COM.Cd_OC=OCD.Cd_OC and (COM.Cd_Prod=OCD.Cd_Prod or COM.Cd_Srv=OCD.Cd_Srv)
...
--exec Rpt_OCPendientes '11111111111','01/01/2011','31/12/2011','C',null
--exec Rpt_OCPendientes '11111111111','01/01/2011','31/12/2011','P',null
--exec Rpt_OCPendientes '11111111111','01/01/2011','31/12/2011','O',null
--exec Rpt_OCPendientes '11111111111','01/01/2011','31/12/2011','Z',null
