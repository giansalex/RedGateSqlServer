...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Pre_CCPresupuestados_Explo2_1]
	...
	Begin
		...
		Begin
			...
			Set @P5_SQL_CC_Cta1 = 
				...
				left Join PlanCtas r On r.RucE=TablaCC_Cta.RucE and r.Ejer=TablaCC_Cta.Ejer and r.NroCta=TablaCC_Cta.NroCta
		...
		Begin
			...
			Set @P5_SQL_SC_Cta1 = 
				...
				Group by p.RucE,p.Ejer,p.Cd_CC,p.Cd_SC,p.Cd_SS,'+@cod_x_cta1+@GroupColum+@GroupColumT+'
					...
					left Join PlanCtas r On r.RucE=TablaSC_Cta.RucE and r.Ejer=TablaSC_Cta.Ejer and r.NroCta=TablaSC_Cta.NroCta
	...
	Begin
		...
		Begin
			...
			Set @P5_SQL_SS_Cta1 =
				...
				Left Join PlanCtas r On r.RucE=TablaSS_Cta.RucE and r.Ejer=TablaSS_Cta.Ejer and r.NroCta=TablaSS_Cta.NroCta
