...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Com_SolicitudReqCons_explo_PagAnt] --<Explorador de Solicitud de Requerimientos>
@RucE nvarchar(11),
--@Ejer nvarchar(4),
@FecD datetime,
@FecH datetime,
...
print 'Cadena = '+@Cond
	...
	Set @CONSULTA='	select *from (select top '+Convert(nvarchar,@TamPag)+' sc.Cd_SR,sc.NroSR,
			...
			sc.FecMdf,sc.UsuCrea,sc.UsuMdf,sc.Id_EstSR,sc.Cd_CC,sc.Cd_SC,sc.Cd_SS, sc.IB_Aut
			from '+@Inter+'
...
exec Com_SolicitudReqCons_explo_PagAnt '11111111111','10/01/2010','20/08/2010','Cd_SR','SR00000001',5,'SR00000006',@Max out,@Min out,null
*/
GO
