...
SET ANSI_NULLS ON
GO
CREATE Procedure [user321].[Rpt_InvBlc_Cta40]
@RucE nvarchar(11),
@Ejer varchar(4),
@Cd_Mda char(2),
@FecIni datetime,
...
as
	if not exists ( select top 1 *from voucher where RucE=@RucE and Ejer=@Ejer and left(NroCta,@nivel) like '40%')
		set @msj='No se encontraron Registros de Inventario de Balances para la Cuenta 40'
