...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Inv_Producto2Crea3]
...
--	begin
		...
		insert into Producto2 (RucE,Cd_Prod,Nombre1,Nombre2,Descrip,NCorto,Cta1,Cta2,Cta3,Cta4,Cta5,Cta6,Cta7,Cta8,CodCo1_,CodCo2_,CodCo3_,CodBarras,FecCaducidad,Img,
			...
			UsuCrea,UsuMdf,FecReg,FecMdf,Estado,CA01,CA02,CA03,CA04,CA05,CA06,CA07,CA08,CA09,CA10,IB_PT,IB_MP,IB_EE,IB_Srs,IB_PV,IB_PC,IB_AF)
			...
			@Cd_CC,@Cd_SC,@Cd_SS,@UsuCrea,null,getdate(),null,1,@CA01,@CA02,@CA03,@CA04,@CA05,@CA06,@CA07,@CA08,@CA09,@CA10,@IB_PT,@IB_MP,@IB_EE,@IB_Srs,@IB_PV,@IB_PC,@IB_AF)
		if @@rowcount <= 0
