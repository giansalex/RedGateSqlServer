...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[Gsp_SSCCostosCons_explo_PagAnt1]
@RucE nvarchar(11),
@Cd_CC nvarchar(8),
@Cd_SC nvarchar(8),
@TamPag int,
...
as
	...
	set @Consulta = 
	'select *from (select top '+Convert(nvarchar,@TamPag)+' RucE,Cd_CC,Cd_SC,Cd_SS,Descrip,NCorto,CA01,CA02,CA03,CA04,CA05 from 
