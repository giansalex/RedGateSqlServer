...
SET ANSI_NULLS ON
GO
--[dbo].[Rpt_RegistroCompras5] '20492595498', '2012','01','01','01',1,'Asc',null
--select*from empresa where RSocial like  '%FASS%'
--[dbo].[Rpt_RegistroCompras5] '11111111111', '2012','03','03','01',1,'Asc',null

CREATE procedure [dbo].[Rpt_RegistroCompras5]
@RucE nvarchar(11),
@Ejer nvarchar(4),
@Rprdo1 nvarchar(2),
@Rprdo2 nvarchar(2),
...
from(
		...
		where v.RucE='''+Convert(varchar,@RucE)+''' and v.Ejer='''+Convert(varchar,@Ejer)+''' and v.Prdo between '''+Convert(varchar,@RPrdo1)+''' and '''+Convert(varchar,@RPrdo2)+''' and v.Cd_Fte=''RC''
...
SET @Consulta3 ='	
	...
	select  
		...
		Sum(
			...
			--	when ''40.1.0'' then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			--	else 0 end + 
			--Case(v.NroCta)         
			--	when ''40.1.1.01'' then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			--	when ''40.1.1.10'' then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			--	when ''40.1.1.50'' then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			...
			--	when ''40.1.1.11''  then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			--	when ''2002.01.01'' then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			--	when ''2002.01.00'' Then case('''+Convert(varchar,@Cd_Mda)+''') when ''01'' then v.MtoD-v.MtoH else v.MtoD_ME-v.MtoH_ME end
			--	else 0 end +
...
-- DI : 05/02/2012 <Se agrego los IGV para la empresas que relaciona PRECCO>
-- DI : 07/02/2012 <Se agrego los IGV para la empresas que relaciona PRECCO>
--exec Rpt_RegistroCompras4 '20452574528','2011','04','04','01',null

--select*from Voucher  where RucE='20452574528' and Ejer='20'
GO
